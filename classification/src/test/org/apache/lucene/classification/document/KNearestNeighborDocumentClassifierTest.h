 ...
 */
class KNearestNeighborDocumentClassifierTest
    : public DocumentClassificationTestBase<std::shared_ptr<BytesRef>>
{
  GET_CLASS_NAME(KNearestNeighborDocumentClassifierTest)
...
protected:
  std::shared_ptr<KNearestNeighborDocumentClassifierTest> shared_from_this()
  {
    return std::static_pointer_cast<KNearestNeighborDocumentClassifierTest>(
