 ...
 */
class SimpleNaiveBayesClassifierTest
    : public ClassificationTestBase<std::shared_ptr<BytesRef>>
{
  GET_CLASS_NAME(SimpleNaiveBayesClassifierTest)
...
protected:
  std::shared_ptr<SimpleNaiveBayesClassifierTest> shared_from_this()
  {
    return std::static_pointer_cast<SimpleNaiveBayesClassifierTest>(
