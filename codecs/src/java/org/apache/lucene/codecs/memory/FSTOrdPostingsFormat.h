...
class FSTOrdPostingsFormat final : public PostingsFormat
{
  GET_CLASS_NAME(FSTOrdPostingsFormat)
public:
...
protected:
  std::shared_ptr<FSTOrdPostingsFormat> shared_from_this()
  {
    return std::static_pointer_cast<FSTOrdPostingsFormat>(
