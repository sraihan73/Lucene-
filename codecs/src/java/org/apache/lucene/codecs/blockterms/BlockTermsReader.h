...
#include  "core/src/java/org/apache/lucene/codecs/blockterms/FieldReader.h"
#include  "core/src/java/org/apache/lucene/codecs/blockterms/TermsIndexReaderBase.h"
