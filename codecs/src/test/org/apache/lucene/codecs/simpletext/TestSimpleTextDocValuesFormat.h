 ...
 */
class TestSimpleTextDocValuesFormat : public BaseDocValuesFormatTestCase
{
  GET_CLASS_NAME(TestSimpleTextDocValuesFormat)
private:
...
protected:
  std::shared_ptr<TestSimpleTextDocValuesFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestSimpleTextDocValuesFormat>(
