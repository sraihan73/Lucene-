...
// ORIGINAL LINE: @Nightly public class TestSimpleTextPostingsFormat extends
// org.apache.lucene.index.BasePostingsFormatTestCase
class TestSimpleTextPostingsFormat : public BasePostingsFormatTestCase
{
private:
...
protected:
  std::shared_ptr<TestSimpleTextPostingsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestSimpleTextPostingsFormat>(
