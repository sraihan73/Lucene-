#pragma once
#include "../../../../../../../../test-framework/src/java/org/apache/lucene/index/BasePointsFormatTestCase.h"
 ...
 */
class TestSimpleTextPointsFormat : public BasePointsFormatTestCase
{
  GET_CLASS_NAME(TestSimpleTextPointsFormat)
private:
...
protected:
  std::shared_ptr<TestSimpleTextPointsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestSimpleTextPointsFormat>(
