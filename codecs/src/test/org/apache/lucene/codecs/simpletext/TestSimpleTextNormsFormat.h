...
class TestSimpleTextNormsFormat : public BaseNormsFormatTestCase
{
  GET_CLASS_NAME(TestSimpleTextNormsFormat)
private:
...
protected:
  std::shared_ptr<TestSimpleTextNormsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestSimpleTextNormsFormat>(
