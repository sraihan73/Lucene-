...
#include "../lucene50/Lucene50SegmentInfoFormat.h"
...
// ORIGINAL LINE: @Deprecated public class Lucene60Codec extends
// org.apache.lucene.codecs.Codec
class Lucene60Codec : public Codec
{
private:
  ...
  const std::shared_ptr<SegmentInfoFormat> segmentInfosFormat =
      std::make_shared<Lucene50SegmentInfoFormat>();
  // C++ NOTE: Fields cannot have the same name as methods:
...
protected:
  std::shared_ptr<Lucene60Codec> shared_from_this()
  {
    return std::static_pointer_cast<Lucene60Codec>(
