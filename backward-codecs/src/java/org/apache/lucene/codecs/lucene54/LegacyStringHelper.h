...
// ORIGINAL LINE: @Deprecated abstract class LegacyStringHelper
class LegacyStringHelper
    : public std::enable_shared_from_this<LegacyStringHelper>
{
   ...
   */
public:
  static int bytesDifference(std::shared_ptr<BytesRef> left,
                             std::shared_ptr<BytesRef> right);
