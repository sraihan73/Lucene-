...
class TestForUtil : public LuceneTestCase
{
  GET_CLASS_NAME(TestForUtil)

public:
  virtual void testEncodeDecode() ;

protected:
  std::shared_ptr<TestForUtil> shared_from_this()
  {
    return std::static_pointer_cast<TestForUtil>(
