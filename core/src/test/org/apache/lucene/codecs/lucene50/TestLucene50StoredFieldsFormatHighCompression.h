...
class TestLucene50StoredFieldsFormatHighCompression
    : public BaseStoredFieldsFormatTestCase
{
  GET_CLASS_NAME(TestLucene50StoredFieldsFormatHighCompression)
protected:
   ...
   */
public:
  virtual void testMixedCompressions() ;

  virtual void testInvalidOptions() ;

protected:
  std::shared_ptr<TestLucene50StoredFieldsFormatHighCompression>
  shared_from_this()
  {
