 ...
 */
class TestLucene60FieldInfoFormat : public BaseFieldInfoFormatTestCase
{
  GET_CLASS_NAME(TestLucene60FieldInfoFormat)

protected:
  std::shared_ptr<Codec> getCodec() override;

protected:
  std::shared_ptr<TestLucene60FieldInfoFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestLucene60FieldInfoFormat>(
