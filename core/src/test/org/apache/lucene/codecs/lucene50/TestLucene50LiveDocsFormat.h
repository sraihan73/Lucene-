...
class TestLucene50LiveDocsFormat : public BaseLiveDocsFormatTestCase
{
  GET_CLASS_NAME(TestLucene50LiveDocsFormat)

protected:
  std::shared_ptr<Codec> getCodec() override;

protected:
  std::shared_ptr<TestLucene50LiveDocsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestLucene50LiveDocsFormat>(
