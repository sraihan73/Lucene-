...
class TestLucene50TermVectorsFormat : public BaseTermVectorsFormatTestCase
{
  GET_CLASS_NAME(TestLucene50TermVectorsFormat)
protected:
  std::shared_ptr<Codec> getCodec() override;

protected:
  std::shared_ptr<TestLucene50TermVectorsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestLucene50TermVectorsFormat>(
