...
class TestLucene50StoredFieldsFormat : public BaseStoredFieldsFormatTestCase
{
  GET_CLASS_NAME(TestLucene50StoredFieldsFormat)
protected:
  std::shared_ptr<Codec> getCodec() override;

protected:
  std::shared_ptr<TestLucene50StoredFieldsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestLucene50StoredFieldsFormat>(
