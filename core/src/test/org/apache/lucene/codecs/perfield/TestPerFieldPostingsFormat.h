 ...
 */
class TestPerFieldPostingsFormat : public BasePostingsFormatTestCase
{
  GET_CLASS_NAME(TestPerFieldPostingsFormat)
...
public:
  ...
  void testPostingsEnumReuse()  override;

protected:
  std::shared_ptr<TestPerFieldPostingsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestPerFieldPostingsFormat>(
