...
class TestLongValuesSource : public LuceneTestCase
{
  GET_CLASS_NAME(TestLongValuesSource)
...
protected:
  std::shared_ptr<TestLongValuesSource> shared_from_this()
  {
    return std::static_pointer_cast<TestLongValuesSource>(
