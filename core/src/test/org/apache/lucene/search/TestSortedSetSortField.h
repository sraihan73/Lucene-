...
class TestSortedSetSortField : public LuceneTestCase
{
  GET_CLASS_NAME(TestSortedSetSortField)
...
protected:
  std::shared_ptr<TestSortedSetSortField> shared_from_this()
  {
    return std::static_pointer_cast<TestSortedSetSortField>(
