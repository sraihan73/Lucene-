 ...
 */
class TestSimpleExplanationsOfNonMatches : public TestSimpleExplanations
{
  GET_CLASS_NAME(TestSimpleExplanationsOfNonMatches)
...
protected:
  std::shared_ptr<TestSimpleExplanationsOfNonMatches> shared_from_this()
  {
    return std::static_pointer_cast<TestSimpleExplanationsOfNonMatches>(
