...
class TestNormsFieldExistsQuery : public LuceneTestCase
{
  GET_CLASS_NAME(TestNormsFieldExistsQuery)
...
protected:
  std::shared_ptr<TestNormsFieldExistsQuery> shared_from_this()
  {
    return std::static_pointer_cast<TestNormsFieldExistsQuery>(
