...
#include  "core/src/java/org/apache/lucene/util/RecyclingIntBlockAllocator.h"
 ...
 */
class TestRecyclingIntBlockAllocator : public LuceneTestCase
{
  GET_CLASS_NAME(TestRecyclingIntBlockAllocator)
...
private:
  std::shared_ptr<RecyclingIntBlockAllocator> newAllocator();
...
protected:
  std::shared_ptr<TestRecyclingIntBlockAllocator> shared_from_this()
  {
    return std::static_pointer_cast<TestRecyclingIntBlockAllocator>(
