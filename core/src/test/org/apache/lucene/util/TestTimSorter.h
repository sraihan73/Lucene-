...
class TestTimSorter : public BaseSortTestCase
{
  GET_CLASS_NAME(TestTimSorter)
...
protected:
  std::shared_ptr<TestTimSorter> shared_from_this()
  {
    return std::static_pointer_cast<TestTimSorter>(
