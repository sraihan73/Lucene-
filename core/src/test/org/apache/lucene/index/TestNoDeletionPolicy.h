...
class TestNoDeletionPolicy : public LuceneTestCase
{
  GET_CLASS_NAME(TestNoDeletionPolicy)
...
public:
  ...
  virtual void testAllCommitsRemain() ;

protected:
  std::shared_ptr<TestNoDeletionPolicy> shared_from_this()
  {
    return std::static_pointer_cast<TestNoDeletionPolicy>(
