...
class TestAtomicUpdate : public LuceneTestCase
{
  GET_CLASS_NAME(TestAtomicUpdate)
...
private:
  ...
  public:
    ...
    IndexerThread(std::shared_ptr<IndexWriter> writer,
...
public:
  virtual void
  runTest(std::shared_ptr<Directory> directory) ;

  /*
    Run above stress test against RAMDirectory and then
    FSDirectory.
  */
  virtual void testAtomicUpdates() ;

protected:
  std::shared_ptr<TestAtomicUpdate> shared_from_this()
  {
    return std::static_pointer_cast<TestAtomicUpdate>(
