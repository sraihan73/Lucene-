...
class TestNeverDelete : public LuceneTestCase
{
  GET_CLASS_NAME(TestNeverDelete)
...
private:
  ...
  private:
    std::shared_ptr<TestNeverDelete> outerInstance;
...
protected:
  std::shared_ptr<TestNeverDelete> shared_from_this()
  {
    return std::static_pointer_cast<TestNeverDelete>(
