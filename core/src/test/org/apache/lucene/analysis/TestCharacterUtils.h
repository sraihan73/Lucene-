 ...
 */
class TestCharacterUtils : public LuceneTestCase
{
  GET_CLASS_NAME(TestCharacterUtils)

public:
  virtual void testConversions();

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testNewCharacterBuffer()
  virtual void testNewCharacterBuffer();

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testFillNoHighSurrogate() throws
  // java.io.IOException
  virtual void testFillNoHighSurrogate() ;
...
protected:
  std::shared_ptr<TestCharacterUtils> shared_from_this()
  {
    return std::static_pointer_cast<TestCharacterUtils>(
