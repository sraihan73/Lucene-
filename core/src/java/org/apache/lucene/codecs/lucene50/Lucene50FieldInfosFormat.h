 ...
 * FieldBits,DocValuesBits,DocValuesGen,Attributes&gt;
 ...
 * --&gt; {@link DataOutput#writeInt VInt}</li> <li>Attributes --&gt; {@link
 * DataOutput#writeMapOfStrings Map&lt;std::wstring,std::wstring&gt;}</li> <li>DocValuesGen
 * --&gt; {@link DataOutput#writeLong(long) Int64}</li> <li>Footer --&gt; {@link
 ...
 * @lucene.experimental
 */
class Lucene50FieldInfosFormat final : public FieldInfosFormat
{
  GET_CLASS_NAME(Lucene50FieldInfosFormat)
...
private:
  static Lucene50FieldInfosFormat::StaticConstructor staticConstructor;
...
public:
  ...
  static constexpr int FORMAT_SAFE_MAPS = 1;
  static constexpr int FORMAT_START = FORMAT_SAFE_MAPS;
  static constexpr int FORMAT_CURRENT = FORMAT_SAFE_MAPS;
...
protected:
  std::shared_ptr<Lucene50FieldInfosFormat> shared_from_this()
  {
    return std::static_pointer_cast<Lucene50FieldInfosFormat>(
