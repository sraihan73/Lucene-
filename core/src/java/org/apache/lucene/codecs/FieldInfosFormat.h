...
using FieldInfos = org::apache::lucene::index::FieldInfos; // javadocs
 ...
 * @lucene.experimental
 */
class FieldInfosFormat : public std::enable_shared_from_this<FieldInfosFormat>
{
  GET_CLASS_NAME(FieldInfosFormat)
...
public:
  virtual std::shared_ptr<FieldInfos>
   ...
   *  directory. */
  virtual void write(std::shared_ptr<Directory> directory,
                     std::shared_ptr<SegmentInfo> segmentInfo,
                     const std::wstring &segmentSuffix,
