...
href="http://en.wikipedia.org/wiki/Finite_state_transducer">
 ...
 *    <li>Low object overhead and quick deserialization (byte[]
representation)</li>
 *    <li>{@link org.apache.lucene.util.fst.Util#getByOutput Lookup-by-output}
when the
 *        outputs are in sorted order (e.g., ordinals or file pointers)</li>
 *    <li>Pluggable {@link org.apache.lucene.util.fst.Outputs Outputs}
representation</li>
 *    <li>{@link org.apache.lucene.util.fst.Util#shortestPaths N-shortest-paths}
search by
 *        weight</li>
 *    <li>Enumerators ({@link org.apache.lucene.util.fst.IntsRefFSTEnum IntsRef}
and {@link org.apache.lucene.util.fst.BytesRefFSTEnum BytesRef}) that behave
like {@link java.util.SortedMap SortedMap} iterators
 * </ul>
 * <p>
...
sorted order!
 *     std::wstring inputValues[] = {"cat", "dog", "dogs"};
 ...
 *     BytesRefFSTEnum&lt;Long&gt; iterator = new
