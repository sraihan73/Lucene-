 ...
 */
class MutableValueDate : public MutableValueLong
{
  GET_CLASS_NAME(MutableValueDate)
public:
...
protected:
  std::shared_ptr<MutableValueDate> shared_from_this()
  {
    return std::static_pointer_cast<MutableValueDate>(
        MutableValueLong::shared_from_this());
  }
};
