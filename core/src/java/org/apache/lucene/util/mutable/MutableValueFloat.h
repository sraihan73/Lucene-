 ...
 * <code>false</code> must also <code>value</code> set to <code>0.0F</code> for
 * proper operation.
 */
class MutableValueFloat : public MutableValue
{
  GET_CLASS_NAME(MutableValueFloat)
public:
  float value = 0;
...
protected:
  std::shared_ptr<MutableValueFloat> shared_from_this()
  {
    return std::static_pointer_cast<MutableValueFloat>(
