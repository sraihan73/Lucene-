...
/**
 * {@link MutableValue} implementation of type <code>bool</code>.
 ...
 * <code>false</code> must also <code>value</code> set to <code>false</code> for
 * proper operation.
 */
class MutableValueBool : public MutableValue
{
  GET_CLASS_NAME(MutableValueBool)
public:
  bool value = false;
...
protected:
  std::shared_ptr<MutableValueBool> shared_from_this()
  {
    return std::static_pointer_cast<MutableValueBool>(
