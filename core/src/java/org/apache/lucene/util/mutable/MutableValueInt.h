 ...
 * <code>false</code> must also <code>value</code> set to <code>0</code> for
 * proper operation.
 */
class MutableValueInt : public MutableValue
{
  GET_CLASS_NAME(MutableValueInt)
public:
  int value = 0;
...
protected:
  std::shared_ptr<MutableValueInt> shared_from_this()
  {
    return std::static_pointer_cast<MutableValueInt>(
