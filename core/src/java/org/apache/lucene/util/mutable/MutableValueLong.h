 ...
 * <code>false</code> must also <code>value</code> set to <code>0L</code> for
 * proper operation.
 */
class MutableValueLong : public MutableValue
{
  GET_CLASS_NAME(MutableValueLong)
public:
  int64_t value = 0;
...
protected:
  std::shared_ptr<MutableValueLong> shared_from_this()
  {
    return std::static_pointer_cast<MutableValueLong>(
