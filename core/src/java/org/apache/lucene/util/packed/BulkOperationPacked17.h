 ...
 */
class BulkOperationPacked17 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked17)
...
protected:
  std::shared_ptr<BulkOperationPacked17> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked17>(
