 ...
 */
class BulkOperationPacked2 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked2)
...
protected:
  std::shared_ptr<BulkOperationPacked2> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked2>(
