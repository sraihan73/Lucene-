 ...
 */
class BulkOperationPacked23 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked23)
...
protected:
  std::shared_ptr<BulkOperationPacked23> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked23>(
