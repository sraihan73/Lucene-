 ...
 */
class BulkOperationPacked19 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked19)
...
protected:
  std::shared_ptr<BulkOperationPacked19> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked19>(
