 ...
 */
class BulkOperationPacked7 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked7)
...
protected:
  std::shared_ptr<BulkOperationPacked7> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked7>(
