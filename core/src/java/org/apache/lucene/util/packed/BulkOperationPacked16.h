 ...
 */
class BulkOperationPacked16 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked16)
...
protected:
  std::shared_ptr<BulkOperationPacked16> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked16>(
