 ...
 */
class BulkOperationPacked8 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked8)
...
protected:
  std::shared_ptr<BulkOperationPacked8> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked8>(
