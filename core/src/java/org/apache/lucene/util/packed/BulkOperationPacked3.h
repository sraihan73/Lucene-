 ...
 */
class BulkOperationPacked3 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked3)
...
protected:
  std::shared_ptr<BulkOperationPacked3> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked3>(
