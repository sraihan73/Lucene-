 ...
 */
class BulkOperationPacked11 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked11)
...
protected:
  std::shared_ptr<BulkOperationPacked11> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked11>(
