 ...
 */
class BulkOperationPacked15 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked15)
...
protected:
  std::shared_ptr<BulkOperationPacked15> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked15>(
