 ...
 */
class BulkOperationPacked18 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked18)
...
protected:
  std::shared_ptr<BulkOperationPacked18> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked18>(
