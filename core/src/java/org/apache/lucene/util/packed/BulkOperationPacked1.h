 ...
 */
class BulkOperationPacked1 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked1)
...
protected:
  std::shared_ptr<BulkOperationPacked1> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked1>(
