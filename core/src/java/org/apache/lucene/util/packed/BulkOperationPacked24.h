 ...
 */
class BulkOperationPacked24 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked24)
...
protected:
  std::shared_ptr<BulkOperationPacked24> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked24>(
