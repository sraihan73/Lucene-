 ...
 */
class BulkOperationPacked4 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked4)
...
protected:
  std::shared_ptr<BulkOperationPacked4> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked4>(
