 ...
 */
class BulkOperationPacked22 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked22)
...
protected:
  std::shared_ptr<BulkOperationPacked22> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked22>(
