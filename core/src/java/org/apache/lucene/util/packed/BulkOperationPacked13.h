 ...
 */
class BulkOperationPacked13 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked13)
...
protected:
  std::shared_ptr<BulkOperationPacked13> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked13>(
