 ...
 */
class BulkOperationPacked9 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked9)
...
protected:
  std::shared_ptr<BulkOperationPacked9> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked9>(
