 ...
 */
class BulkOperationPacked14 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked14)
...
protected:
  std::shared_ptr<BulkOperationPacked14> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked14>(
