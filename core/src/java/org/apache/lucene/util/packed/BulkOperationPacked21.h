 ...
 */
class BulkOperationPacked21 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked21)
...
protected:
  std::shared_ptr<BulkOperationPacked21> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked21>(
