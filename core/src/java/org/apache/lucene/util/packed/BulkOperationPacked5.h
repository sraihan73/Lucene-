 ...
 */
class BulkOperationPacked5 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked5)
...
protected:
  std::shared_ptr<BulkOperationPacked5> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked5>(
