 ...
 */
class BulkOperationPacked12 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked12)
...
protected:
  std::shared_ptr<BulkOperationPacked12> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked12>(
