 ...
 */
class BulkOperationPacked20 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked20)
...
protected:
  std::shared_ptr<BulkOperationPacked20> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked20>(
