 ...
 */
class BulkOperationPacked10 final : public BulkOperationPacked
{
  GET_CLASS_NAME(BulkOperationPacked10)
...
protected:
  std::shared_ptr<BulkOperationPacked10> shared_from_this()
  {
    return std::static_pointer_cast<BulkOperationPacked10>(
