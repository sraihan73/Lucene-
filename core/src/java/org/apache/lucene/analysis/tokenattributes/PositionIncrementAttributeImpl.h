...
class PositionIncrementAttributeImpl : public AttributeImpl,
                                       public PositionIncrementAttribute,
                                       public Cloneable
{
  GET_CLASS_NAME(PositionIncrementAttributeImpl)
private:
...
protected:
  std::shared_ptr<PositionIncrementAttributeImpl> shared_from_this()
  {
    return std::static_pointer_cast<PositionIncrementAttributeImpl>(
