...
{
  GET_CLASS_NAME(SortedDocValuesField)
...
private:
  static SortedDocValuesField::StaticConstructor staticConstructor;
   ...
   */
public:
  SortedDocValuesField(const std::wstring &name,
...
protected:
  std::shared_ptr<SortedDocValuesField> shared_from_this()
  {
    return std::static_pointer_cast<SortedDocValuesField>(
