...
class FlushInfo : public std::enable_shared_from_this<FlushInfo>
{
  GET_CLASS_NAME(FlushInfo)

public:
  const int numDocs;

  const int64_t estimatedSegmentSize;
  ...
  FlushInfo(int numDocs, int64_t estimatedSegmentSize);
