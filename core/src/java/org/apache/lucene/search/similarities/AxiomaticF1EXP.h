 ...
 * @lucene.experimental
 */
class AxiomaticF1EXP : public Axiomatic
{
  GET_CLASS_NAME(AxiomaticF1EXP)
  /**
   ...
   */
public:
  AxiomaticF1EXP(float s, float k);
...
protected:
  std::shared_ptr<AxiomaticF1EXP> shared_from_this()
  {
    return std::static_pointer_cast<AxiomaticF1EXP>(
