 ...
 * @lucene.experimental
 */
class IndependenceSaturated : public Independence
{
  GET_CLASS_NAME(IndependenceSaturated)
...
protected:
  std::shared_ptr<IndependenceSaturated> shared_from_this()
  {
    return std::static_pointer_cast<IndependenceSaturated>(
