 ...
 * @lucene.experimental
 */
class AfterEffectB : public AfterEffect
{
  GET_CLASS_NAME(AfterEffectB)
...
protected:
  std::shared_ptr<AfterEffectB> shared_from_this()
  {
    return std::static_pointer_cast<AfterEffectB>(
