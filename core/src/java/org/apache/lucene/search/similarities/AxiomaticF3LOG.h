 ...
 * @lucene.experimental
 */
class AxiomaticF3LOG : public Axiomatic
{
  GET_CLASS_NAME(AxiomaticF3LOG)
   ...
   */
public:
  AxiomaticF3LOG(float s, int queryLen);
...
protected:
  std::shared_ptr<AxiomaticF3LOG> shared_from_this()
  {
    return std::static_pointer_cast<AxiomaticF3LOG>(
