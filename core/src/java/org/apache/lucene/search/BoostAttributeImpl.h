 ...
 * @lucene.internal
 */
class BoostAttributeImpl final : public AttributeImpl, public BoostAttribute
{
  GET_CLASS_NAME(BoostAttributeImpl)
private:
  float boost = 1.0f;
...
protected:
  std::shared_ptr<BoostAttributeImpl> shared_from_this()
  {
    return std::static_pointer_cast<BoostAttributeImpl>(
