...
class TestFloatPointNearestNeighbor : public LuceneTestCase
{
  GET_CLASS_NAME(TestFloatPointNearestNeighbor)
...
protected:
  std::shared_ptr<TestFloatPointNearestNeighbor> shared_from_this()
  {
    return std::static_pointer_cast<TestFloatPointNearestNeighbor>(
