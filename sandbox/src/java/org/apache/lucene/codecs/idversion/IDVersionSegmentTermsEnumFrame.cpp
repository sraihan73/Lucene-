...
#include "IDVersionSegmentTermsEnumFrame.h"
...
IDVersionSegmentTermsEnumFrame::IDVersionSegmentTermsEnumFrame(
    shared_ptr<IDVersionSegmentTermsEnum> ste, int ord) 
...
void IDVersionSegmentTermsEnumFrame::setFloorData(
    shared_ptr<ByteArrayDataInput> in_, shared_ptr<BytesRef> source)
{
...
int IDVersionSegmentTermsEnumFrame::getTermBlockOrd()
{
  return isLeafBlock ? nextEnt : state->termBlockOrd;
}

void IDVersionSegmentTermsEnumFrame::loadNextFloorBlock() 
{
  // if (DEBUG) {
...
void IDVersionSegmentTermsEnumFrame::loadBlock() 
{
...
void IDVersionSegmentTermsEnumFrame::rewind()
{
...
bool IDVersionSegmentTermsEnumFrame::next()
{
  return isLeafBlock ? nextLeaf() : nextNonLeaf();
}

bool IDVersionSegmentTermsEnumFrame::nextLeaf()
{
...
bool IDVersionSegmentTermsEnumFrame::nextNonLeaf()
{
  // if (DEBUG) System.out.println("  frame.next ord=" + ord + " nextEnt=" +
  // nextEnt + " entCount=" + entCount);
  assert((nextEnt != -1 && nextEnt < entCount,
...
void IDVersionSegmentTermsEnumFrame::scanToFloorFrame(
...
void IDVersionSegmentTermsEnumFrame::decodeMetaData() 
{
...
bool IDVersionSegmentTermsEnumFrame::prefixMatches(shared_ptr<BytesRef> target)
{
...
void IDVersionSegmentTermsEnumFrame::scanToSubBlock(int64_t subFP)
{
  assert(!isLeafBlock);
...
SeekStatus
IDVersionSegmentTermsEnumFrame::scanToTerm(shared_ptr<BytesRef> target,
                                           bool exactOnly) 
{
...
SeekStatus IDVersionSegmentTermsEnumFrame::scanToTermLeaf(
    shared_ptr<BytesRef> target, bool exactOnly) 
{

  // if (DEBUG) System.out.println("    scanToTermLeaf: block fp=" + fp + "
  // prefix=" + prefix + " nextEnt=" + nextEnt + " (of " + entCount + ")
  // target=" + IDVersionSegmentTermsEnum.brToString(target) + " term=" +
...
SeekStatus IDVersionSegmentTermsEnumFrame::scanToTermNonLeaf(
    shared_ptr<BytesRef> target, bool exactOnly) 
{
...
void IDVersionSegmentTermsEnumFrame::fillTerm()
{
