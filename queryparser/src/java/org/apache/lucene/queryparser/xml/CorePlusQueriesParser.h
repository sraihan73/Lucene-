 ...
 */
class CorePlusQueriesParser : public CoreParser
{
  GET_CLASS_NAME(CorePlusQueriesParser)
   ...
   */
public:
  CorePlusQueriesParser(std::shared_ptr<Analyzer> analyzer,
   ...
   * for UserQuery tags
   */
  CorePlusQueriesParser(const std::wstring &defaultField,
...
protected:
  std::shared_ptr<CorePlusQueriesParser> shared_from_this()
  {
    return std::static_pointer_cast<CorePlusQueriesParser>(
        CoreParser::shared_from_this());
  }
};
