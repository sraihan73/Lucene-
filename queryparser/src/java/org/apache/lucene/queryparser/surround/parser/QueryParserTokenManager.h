...
#include  "core/src/java/org/apache/lucene/queryparser/surround/parser/CharStream.h"

#include  "core/src/java/org/apache/lucene/queryparser/surround/parser/Token.h"
...
public:
  ...
  static std::deque<int64_t> const jjbitVec2;
...
private:
  std::deque<int> const jjrounds = std::deque<int>(38);
  std::deque<int> const jjstateSet = std::deque<int>(76);
