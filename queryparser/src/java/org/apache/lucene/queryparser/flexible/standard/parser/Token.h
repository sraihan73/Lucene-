...
public:
   ...
   */
  Token(int kind, const std::wstring &image);
   ...
   */
  static std::shared_ptr<Token> newToken(int ofKind, const std::wstring &image);

  static std::shared_ptr<Token> newToken(int ofKind);
};
/* JavaCC - OriginalChecksum=30bbd23e0dec26f141130dc62a4f6e9d (do not edit this
 * line) */
