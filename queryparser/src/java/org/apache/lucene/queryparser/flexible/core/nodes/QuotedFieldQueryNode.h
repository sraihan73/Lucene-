 ...
 * "life is great"
 */
class QuotedFieldQueryNode : public FieldQueryNode
{
  GET_CLASS_NAME(QuotedFieldQueryNode)
   ...
   */
public:
  QuotedFieldQueryNode(std::shared_ptr<std::wstring> field,
  ...
  std::shared_ptr<QuotedFieldQueryNode>
  cloneTree()  override;

protected:
  std::shared_ptr<QuotedFieldQueryNode> shared_from_this()
  {
    return std::static_pointer_cast<QuotedFieldQueryNode>(
