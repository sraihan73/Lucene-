...
class RegexpQueryNodeProcessor : public QueryNodeProcessorImpl
{
  GET_CLASS_NAME(RegexpQueryNodeProcessor)
...
protected:
  std::shared_ptr<RegexpQueryNodeProcessor> shared_from_this()
  {
    return std::static_pointer_cast<RegexpQueryNodeProcessor>(
