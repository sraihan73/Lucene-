...
ParseException::ParseException(
    ...
    : QueryNodeParseException(
          new MessageImpl(QueryParserMessages::INVALID_SYNTAX,
                          initialise(currentTokenVal, expectedTokenSequencesVal,
                                     tokenImageVal)))
{
...
ParseException::ParseException()
    : QueryNodeParseException(
          new MessageImpl(QueryParserMessages::INVALID_SYNTAX, L"Error"))
{
}

ParseException::ParseException(shared_ptr<Message> message)
