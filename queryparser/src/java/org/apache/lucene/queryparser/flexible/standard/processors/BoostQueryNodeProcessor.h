 ...
 * @see FieldableNode
 */
class BoostQueryNodeProcessor : public QueryNodeProcessorImpl
{
  GET_CLASS_NAME(BoostQueryNodeProcessor)
...
protected:
  std::shared_ptr<BoostQueryNodeProcessor> shared_from_this()
  {
    return std::static_pointer_cast<BoostQueryNodeProcessor>(
