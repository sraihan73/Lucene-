...
#include  "core/src/java/org/apache/lucene/search/RegexpQuery.h"
...
class RegexpQueryNodeBuilder
    : public std::enable_shared_from_this<RegexpQueryNodeBuilder>,
      public StandardQueryBuilder
{
  GET_CLASS_NAME(RegexpQueryNodeBuilder)

public:
  RegexpQueryNodeBuilder();

  std::shared_ptr<RegexpQuery> build(
