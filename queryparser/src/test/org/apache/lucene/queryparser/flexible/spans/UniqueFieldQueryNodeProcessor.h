 ...
 */
class UniqueFieldQueryNodeProcessor : public QueryNodeProcessorImpl
{
  GET_CLASS_NAME(UniqueFieldQueryNodeProcessor)
...
protected:
  std::shared_ptr<UniqueFieldQueryNodeProcessor> shared_from_this()
  {
    return std::static_pointer_cast<UniqueFieldQueryNodeProcessor>(
