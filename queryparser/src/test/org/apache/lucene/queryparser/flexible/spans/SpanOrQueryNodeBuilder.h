...
/**
 * This builder creates {@link SpanOrQuery}s from a {@link
 * BooleanQueryNode}.<br> <br>
 *
 * It assumes that the {@link BooleanQueryNode} instance has at least one child.
 */
class SpanOrQueryNodeBuilder
    : public std::enable_shared_from_this<SpanOrQueryNodeBuilder>,
      public StandardQueryBuilder
{
  GET_CLASS_NAME(SpanOrQueryNodeBuilder)

public:
  std::shared_ptr<SpanOrQuery>
