 ...
 */
class SpansValidatorQueryNodeProcessor : public QueryNodeProcessorImpl
{
  GET_CLASS_NAME(SpansValidatorQueryNodeProcessor)
...
protected:
  std::shared_ptr<SpansValidatorQueryNodeProcessor> shared_from_this()
  {
    return std::static_pointer_cast<SpansValidatorQueryNodeProcessor>(
