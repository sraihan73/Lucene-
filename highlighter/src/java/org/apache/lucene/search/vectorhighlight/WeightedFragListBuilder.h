 ...
 */
class WeightedFragListBuilder : public BaseFragListBuilder
{
  GET_CLASS_NAME(WeightedFragListBuilder)

public:
  WeightedFragListBuilder();

  WeightedFragListBuilder(int margin);
...
protected:
  std::shared_ptr<WeightedFragListBuilder> shared_from_this()
  {
    return std::static_pointer_cast<WeightedFragListBuilder>(
        BaseFragListBuilder::shared_from_this());
  }
};
