 ...
 */
class SimpleFragListBuilder : public BaseFragListBuilder
{
  GET_CLASS_NAME(SimpleFragListBuilder)
...
protected:
  std::shared_ptr<SimpleFragListBuilder> shared_from_this()
  {
    return std::static_pointer_cast<SimpleFragListBuilder>(
