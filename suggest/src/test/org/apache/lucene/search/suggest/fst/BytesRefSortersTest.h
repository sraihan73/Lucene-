...
class BytesRefSortersTest : public LuceneTestCase
{
  GET_CLASS_NAME(BytesRefSortersTest)
public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testExternalRefSorter() throws Exception
  virtual void testExternalRefSorter() ;

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testInMemorySorter() throws Exception
  virtual void testInMemorySorter() ;

private:
  void check(std::shared_ptr<BytesRefSorter> sorter) ;

protected:
  std::shared_ptr<BytesRefSortersTest> shared_from_this()
  {
    return std::static_pointer_cast<BytesRefSortersTest>(
