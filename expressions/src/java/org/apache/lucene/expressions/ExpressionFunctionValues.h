...
class ExpressionFunctionValues : public DoubleValues
{
  GET_CLASS_NAME(ExpressionFunctionValues)
public:
  const std::shared_ptr<Expression> expression;
  std::deque<std::shared_ptr<DoubleValues>> const functionValues;
...
protected:
  std::shared_ptr<ExpressionFunctionValues> shared_from_this()
  {
    return std::static_pointer_cast<ExpressionFunctionValues>(
