 ...
 */
class TestExpressionSorts : public LuceneTestCase
{
  GET_CLASS_NAME(TestExpressionSorts)
private:
...
protected:
  std::shared_ptr<TestExpressionSorts> shared_from_this()
  {
    return std::static_pointer_cast<TestExpressionSorts>(
