...
class TestCustomScoreExplanations : public BaseExplanationTestCase
{
  GET_CLASS_NAME(TestCustomScoreExplanations)
public:
...
protected:
  std::shared_ptr<TestCustomScoreExplanations> shared_from_this()
  {
    return std::static_pointer_cast<TestCustomScoreExplanations>(
