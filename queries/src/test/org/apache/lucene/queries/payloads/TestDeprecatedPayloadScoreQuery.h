...
#include  "core/src/java/org/apache/lucene/queries/payloads/JustScorePayloadSimilarity.h"
...
class TestDeprecatedPayloadScoreQuery : public LuceneTestCase
{
  GET_CLASS_NAME(TestDeprecatedPayloadScoreQuery)
...
public:
  class MultiplyingSimilarity : public ClassicSimilarity
  {
    GET_CLASS_NAME(MultiplyingSimilarity)
  ...
  protected:
    std::shared_ptr<MultiplyingSimilarity> shared_from_this()
    {
      return std::static_pointer_cast<MultiplyingSimilarity>(
...
public:
  class JustScorePayloadSimilarity : public MultiplyingSimilarity
  {
  ...
  protected:
    std::shared_ptr<JustScorePayloadSimilarity> shared_from_this()
    {
      return std::static_pointer_cast<JustScorePayloadSimilarity>(
          MultiplyingSimilarity::shared_from_this());
    }
  };

protected:
  std::shared_ptr<TestDeprecatedPayloadScoreQuery> shared_from_this()
  {
    return std::static_pointer_cast<TestDeprecatedPayloadScoreQuery>(
