...
#include "TestDeprecatedPayloadScoreQuery.h"
...
void TestDeprecatedPayloadScoreQuery::checkQuery(
    ...
    std::deque<float> &expectedScores) 
{
  ...
  shared_ptr<PayloadScoreQuery> psq =
      make_shared<PayloadScoreQuery>(query, function, includeSpanScore);
...
void TestDeprecatedPayloadScoreQuery::testTermQuery() 
{
...
void TestDeprecatedPayloadScoreQuery::testOrQuery() 
{
...
void TestDeprecatedPayloadScoreQuery::testNearQuery() 
{
...
void TestDeprecatedPayloadScoreQuery::testNestedNearQuery() 
{
  ...
  searcher->setSimilarity(make_shared<MultiplyingSimilarity>());
  try {
...
void TestDeprecatedPayloadScoreQuery::testSpanContainingQuery() throw(
    runtime_error)
{
...
void TestDeprecatedPayloadScoreQuery::testEquality()
{
  ...
  shared_ptr<PayloadScoreQuery> query1 =
      make_shared<PayloadScoreQuery>(sq1, minFunc, true);
  shared_ptr<PayloadScoreQuery> query2 =
      make_shared<PayloadScoreQuery>(sq2, minFunc, true);
  shared_ptr<PayloadScoreQuery> query3 =
      make_shared<PayloadScoreQuery>(sq2, maxFunc, true);
  shared_ptr<PayloadScoreQuery> query4 =
      make_shared<PayloadScoreQuery>(sq2, maxFunc, false);
  shared_ptr<PayloadScoreQuery> query5 =
      make_shared<PayloadScoreQuery>(sq1, minFunc);
...
void TestDeprecatedPayloadScoreQuery::testRewrite() 
{
  ...
  shared_ptr<PayloadScoreQuery> psq = make_shared<PayloadScoreQuery>(
      xyz, make_shared<AveragePayloadFunction>(), false);
...
shared_ptr<org::apache::lucene::search::IndexSearcher>
    TestDeprecatedPayloadScoreQuery::searcher;
shared_ptr<org::apache::lucene::index::IndexReader>
    TestDeprecatedPayloadScoreQuery::reader;
shared_ptr<org::apache::lucene::store::Directory>
    TestDeprecatedPayloadScoreQuery::directory;
shared_ptr<JustScorePayloadSimilarity>
    TestDeprecatedPayloadScoreQuery::similarity =
        make_shared<JustScorePayloadSimilarity>();
std::deque<char> TestDeprecatedPayloadScoreQuery::payload2 = {2};
std::deque<char> TestDeprecatedPayloadScoreQuery::payload4 = {4};

shared_ptr<Analyzer::TokenStreamComponents>
TestDeprecatedPayloadScoreQuery::PayloadAnalyzer::createComponents(
...
TestDeprecatedPayloadScoreQuery::PayloadFilter::PayloadFilter(
...
bool TestDeprecatedPayloadScoreQuery::PayloadFilter::incrementToken() throw(
    IOException)
{
  bool result = false;
...
void TestDeprecatedPayloadScoreQuery::PayloadFilter::reset() 
{
  TokenFilter::reset();
  this->numSeen = 0;
}
...
void TestDeprecatedPayloadScoreQuery::beforeClass() 
{
...
void TestDeprecatedPayloadScoreQuery::afterClass() 
{
  searcher.reset();
  delete reader;
  reader.reset();
...
float TestDeprecatedPayloadScoreQuery::MultiplyingSimilarity::scorePayload(
...
float TestDeprecatedPayloadScoreQuery::JustScorePayloadSimilarity::lengthNorm(
    int length)
{
  return 1;
}

float TestDeprecatedPayloadScoreQuery::JustScorePayloadSimilarity::sloppyFreq(
    int distance)
{
  return 1.0f;
}

float TestDeprecatedPayloadScoreQuery::JustScorePayloadSimilarity::tf(
    float freq)
{
  return 1.0f;
}
...
TestDeprecatedPayloadScoreQuery::JustScorePayloadSimilarity::idfExplain(
