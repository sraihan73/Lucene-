 ...
 * excluding deletions.
 */
class NumDocsValueSource : public ValueSource
{
  GET_CLASS_NAME(NumDocsValueSource)
public:
...
protected:
  std::shared_ptr<NumDocsValueSource> shared_from_this()
  {
    return std::static_pointer_cast<NumDocsValueSource>(
