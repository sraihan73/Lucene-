 ...
 */
class MinFloatFunction : public MultiFloatFunction
{
  GET_CLASS_NAME(MinFloatFunction)
public:
  MinFloatFunction(std::deque<std::shared_ptr<ValueSource>> &sources);
...
protected:
  std::shared_ptr<MinFloatFunction> shared_from_this()
  {
    return std::static_pointer_cast<MinFloatFunction>(
