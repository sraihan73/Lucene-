...
class LinearSquaredDistance
    : public std::enable_shared_from_this<LinearSquaredDistance>,
      public DistanceStyle
{
  GET_CLASS_NAME(LinearSquaredDistance)

  /** A convenient instance */
public:
  static const std::shared_ptr<LinearSquaredDistance> INSTANCE;
