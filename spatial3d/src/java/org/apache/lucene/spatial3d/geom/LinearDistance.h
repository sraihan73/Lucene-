 ...
 * @lucene.experimental
 */
class LinearDistance : public std::enable_shared_from_this<LinearDistance>,
                       public DistanceStyle
{
  GET_CLASS_NAME(LinearDistance)

  /** A convenient instance */
public:
  static const std::shared_ptr<LinearDistance> INSTANCE;
