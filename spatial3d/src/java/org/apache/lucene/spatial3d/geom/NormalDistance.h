 ...
 * @lucene.experimental
 */
class NormalDistance : public std::enable_shared_from_this<NormalDistance>,
                       public DistanceStyle
{
  GET_CLASS_NAME(NormalDistance)

  /** A convenient instance */
public:
  static const std::shared_ptr<NormalDistance> INSTANCE;
