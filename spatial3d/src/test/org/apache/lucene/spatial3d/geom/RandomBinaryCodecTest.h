 ...
 */
class RandomBinaryCodecTest : public RandomGeo3dShapeGenerator
{
  GET_CLASS_NAME(RandomBinaryCodecTest)

public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test @Repeat(iterations = 10) public void
  // testRandomPointCodec() throws java.io.IOException
  virtual void testRandomPointCodec() ;

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test @Repeat(iterations = 100) public void
  // testRandomPlanetObjectCodec() throws java.io.IOException
  virtual void testRandomPlanetObjectCodec() ;

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test @Repeat(iterations = 100) public void
  // testRandomShapeCodec() throws java.io.IOException
  virtual void testRandomShapeCodec() ;

protected:
  std::shared_ptr<RandomBinaryCodecTest> shared_from_this()
  {
    return std::static_pointer_cast<RandomBinaryCodecTest>(
