...
class TestTermQueryPrefixGridStrategy : public SpatialTestCase
{
  GET_CLASS_NAME(TestTermQueryPrefixGridStrategy)

public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testNGramPrefixGridLosAngeles() throws
  // java.io.IOException
  virtual void testNGramPrefixGridLosAngeles() ;

protected:
  std::shared_ptr<TestTermQueryPrefixGridStrategy> shared_from_this()
  {
    return std::static_pointer_cast<TestTermQueryPrefixGridStrategy>(
