...
class SerializedStrategyTest : public StrategyTestCase
{
  GET_CLASS_NAME(SerializedStrategyTest)
...
protected:
  std::shared_ptr<SerializedStrategyTest> shared_from_this()
  {
    return std::static_pointer_cast<SerializedStrategyTest>(
