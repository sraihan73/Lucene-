 ...
 */
class TestTestFramework : public LuceneTestCase
{
  GET_CLASS_NAME(TestTestFramework)
...
public:
  ...
  virtual void spatialExample() ;

protected:
  std::shared_ptr<TestTestFramework> shared_from_this()
  {
    return std::static_pointer_cast<TestTestFramework>(
