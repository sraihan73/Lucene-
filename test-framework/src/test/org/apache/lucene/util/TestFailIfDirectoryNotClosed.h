...
class TestFailIfDirectoryNotClosed : public WithNestedTests
{
  GET_CLASS_NAME(TestFailIfDirectoryNotClosed)
public:
...
public:
  ...
  virtual void testFailIfDirectoryNotClosed();

protected:
  std::shared_ptr<TestFailIfDirectoryNotClosed> shared_from_this()
  {
    return std::static_pointer_cast<TestFailIfDirectoryNotClosed>(
