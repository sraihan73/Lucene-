...
class TestFailIfUnreferencedFiles : public WithNestedTests
{
  GET_CLASS_NAME(TestFailIfUnreferencedFiles)
public:
  TestFailIfUnreferencedFiles();
...
public:
  ...
  virtual void testFailIfUnreferencedFiles();

protected:
  std::shared_ptr<TestFailIfUnreferencedFiles> shared_from_this()
  {
    return std::static_pointer_cast<TestFailIfUnreferencedFiles>(
