...
class TestAssertingDocValuesFormat : public BaseDocValuesFormatTestCase
{
  GET_CLASS_NAME(TestAssertingDocValuesFormat)
private:
...
protected:
  std::shared_ptr<TestAssertingDocValuesFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestAssertingDocValuesFormat>(
