...
class TestAssertingStoredFieldsFormat : public BaseTermVectorsFormatTestCase
{
  GET_CLASS_NAME(TestAssertingStoredFieldsFormat)
private:
...
protected:
  std::shared_ptr<TestAssertingStoredFieldsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestAssertingStoredFieldsFormat>(
