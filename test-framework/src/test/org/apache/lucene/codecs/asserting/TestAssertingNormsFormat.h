...
class TestAssertingNormsFormat : public BaseNormsFormatTestCase
{
  GET_CLASS_NAME(TestAssertingNormsFormat)
private:
...
protected:
  std::shared_ptr<TestAssertingNormsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestAssertingNormsFormat>(
