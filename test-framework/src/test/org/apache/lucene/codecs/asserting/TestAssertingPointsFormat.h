...
class TestAssertingPointsFormat : public BasePointsFormatTestCase
{
  GET_CLASS_NAME(TestAssertingPointsFormat)
private:
...
protected:
  std::shared_ptr<TestAssertingPointsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestAssertingPointsFormat>(
