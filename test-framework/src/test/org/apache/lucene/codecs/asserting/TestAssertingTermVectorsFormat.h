...
class TestAssertingTermVectorsFormat : public BaseTermVectorsFormatTestCase
{
  GET_CLASS_NAME(TestAssertingTermVectorsFormat)
private:
...
protected:
  std::shared_ptr<TestAssertingTermVectorsFormat> shared_from_this()
  {
    return std::static_pointer_cast<TestAssertingTermVectorsFormat>(
