...
class TestDisableFsyncFS : public MockFileSystemTestCase
{
  GET_CLASS_NAME(TestDisableFsyncFS)
...
public:
  virtual void testFsyncWorks() ;

protected:
  std::shared_ptr<TestDisableFsyncFS> shared_from_this()
  {
    return std::static_pointer_cast<TestDisableFsyncFS>(
