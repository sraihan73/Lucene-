...
class TestVirusCheckingFS : public MockFileSystemTestCase
{
  GET_CLASS_NAME(TestVirusCheckingFS)
...
public:
  virtual void testDeleteSometimesFails() ;

protected:
  std::shared_ptr<TestVirusCheckingFS> shared_from_this()
  {
    return std::static_pointer_cast<TestVirusCheckingFS>(
