...
class TestLeakFS : public MockFileSystemTestCase
{
  GET_CLASS_NAME(TestLeakFS)
...
public:
  virtual void testLeakInputStream() ;

  /** Test leaks via Files.newOutputStream */
  virtual void testLeakOutputStream() ;

  /** Test leaks via FileChannel.open */
  virtual void testLeakFileChannel() ;

  /** Test leaks via AsynchronousFileChannel.open */
  virtual void testLeakAsyncFileChannel() ;

  /** Test leaks via Files.newByteChannel */
  virtual void testLeakByteChannel() ;

protected:
  std::shared_ptr<TestLeakFS> shared_from_this()
  {
    return std::static_pointer_cast<TestLeakFS>(
