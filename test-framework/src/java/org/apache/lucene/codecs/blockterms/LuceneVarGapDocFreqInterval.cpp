...
#include "LuceneVarGapDocFreqInterval.h"
...
LuceneVarGapDocFreqInterval::LuceneVarGapDocFreqInterval()
    : LuceneVarGapDocFreqInterval(
          1000000, FixedGapTermsIndexWriter::DEFAULT_TERM_INDEX_INTERVAL)
{
}

LuceneVarGapDocFreqInterval::LuceneVarGapDocFreqInterval(int docFreqThreshold,
                                                         int termIndexInterval)
    : org::apache::lucene::codecs::PostingsFormat(
          L"LuceneVarGapDocFreqInterval"),
      termIndexInterval(termIndexInterval), docFreqThreshold(docFreqThreshold)
{
}

shared_ptr<FieldsConsumer> LuceneVarGapDocFreqInterval::fieldsConsumer(
    shared_ptr<SegmentWriteState> state) 
{
  ...
  try {
    indexWriter = make_shared<VariableGapTermsIndexWriter>(
        state,
        make_shared<VariableGapTermsIndexWriter::EveryNOrDocFreqTermSelector>(
...
shared_ptr<FieldsProducer> LuceneVarGapDocFreqInterval::fieldsProducer(
...
const wstring LuceneVarGapDocFreqInterval::FREQ_EXTENSION = L"frq";
const wstring LuceneVarGapDocFreqInterval::PROX_EXTENSION = L"prx";
} // namespace org::apache::lucene::codecs::blockterms