 ...
 */
class LuceneFixedGap final : public PostingsFormat
{
  GET_CLASS_NAME(LuceneFixedGap)
public:
...
protected:
  std::shared_ptr<LuceneFixedGap> shared_from_this()
  {
    return std::static_pointer_cast<LuceneFixedGap>(
