...
class FailOnNonBulkMergesInfoStream : public InfoStream
{
  GET_CLASS_NAME(FailOnNonBulkMergesInfoStream)

public:
  virtual ~FailOnNonBulkMergesInfoStream();
...
protected:
  std::shared_ptr<FailOnNonBulkMergesInfoStream> shared_from_this()
  {
    return std::static_pointer_cast<FailOnNonBulkMergesInfoStream>(
