...
class TestLruTaxonomyWriterCache : public FacetTestCase
{
  GET_CLASS_NAME(TestLruTaxonomyWriterCache)

public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testDefaultLRUTypeIsCollisionSafe()
  virtual void testDefaultLRUTypeIsCollisionSafe();

protected:
  std::shared_ptr<TestLruTaxonomyWriterCache> shared_from_this()
  {
    return std::static_pointer_cast<TestLruTaxonomyWriterCache>(
