...
#include "TaxonomyFacetSumIntAssociations.h"
...
TaxonomyFacetSumIntAssociations::TaxonomyFacetSumIntAssociations(
    shared_ptr<TaxonomyReader> taxoReader, shared_ptr<FacetsConfig> config,
    shared_ptr<FacetsCollector> fc) 
    : TaxonomyFacetSumIntAssociations(FacetsConfig::DEFAULT_INDEX_FIELD_NAME,
...
void TaxonomyFacetSumIntAssociations::sumValues(
