 ...
 *
 *  @lucene.experimental */
class TaxonomyFacetSumFloatAssociations : public FloatTaxonomyFacets
{
  GET_CLASS_NAME(TaxonomyFacetSumFloatAssociations)
...
protected:
  std::shared_ptr<TaxonomyFacetSumFloatAssociations> shared_from_this()
  {
    return std::static_pointer_cast<TaxonomyFacetSumFloatAssociations>(
