 ...
 * <ul>
 *   <li>A <a
 * href="{@docRoot}/../core/org/apache/lucene/search/IndexSearcher.html">IndexSearcher</a>.</li>
 *   <li>{@link org.apache.lucene.benchmark.quality.QualityQuery Quality
 * queries}.</li> <li>{@link org.apache.lucene.benchmark.quality.Judge Judging
 * object}.</li> <li>{@link
 * org.apache.lucene.benchmark.quality.utils.SubmissionReport Reporting
 * object}.</li>
 * </ul>
 * <p>
 ...
 * <p>
 * Here is a sample code used to run the TREC 2006 queries 701-850 on the .Gov2
 * collection:
 *
 ...
 *
 *     int maxResults = 1000;
 *     std::wstring docNameField = "docname";
 *
 ...
 * docNameField); SubmissionReport submitLog = null; QualityStats stats[] =
 * qrun.execute(maxResults, judge, submitLog, logger);
 *
 ...
 *       {@link org.apache.lucene.benchmark.quality.QualityQuery Quality
 * queries}.</li> <li>Create sophisticated Lucene queries by supplying a
 * different
 *   {@link org.apache.lucene.benchmark.quality.QualityQueryParser Quality query
 * parser}.</li>
 * </ul>
 */
