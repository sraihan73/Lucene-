 ...
 */
class TrecParserByPath : public TrecDocParser
{
  GET_CLASS_NAME(TrecParserByPath)
...
protected:
  std::shared_ptr<TrecParserByPath> shared_from_this()
  {
    return std::static_pointer_cast<TrecParserByPath>(
