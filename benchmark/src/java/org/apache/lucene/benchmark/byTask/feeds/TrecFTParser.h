 ...
 */
class TrecFTParser : public TrecDocParser
{
  GET_CLASS_NAME(TrecFTParser)
...
protected:
  std::shared_ptr<TrecFTParser> shared_from_this()
  {
    return std::static_pointer_cast<TrecFTParser>(
