 ...
 * <br>
 * file.query.maker.default.field=&lt;Name of default field - Default value is
 * "body"&gt;
 *
 * Example:
 ...
 */
class FileBasedQueryMaker : public AbstractQueryMaker, public QueryMaker
{
  GET_CLASS_NAME(FileBasedQueryMaker)
...
protected:
  std::shared_ptr<FileBasedQueryMaker> shared_from_this()
  {
    return std::static_pointer_cast<FileBasedQueryMaker>(
