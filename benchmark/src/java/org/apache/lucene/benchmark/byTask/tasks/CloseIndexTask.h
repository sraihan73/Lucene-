 ...
 */
class CloseIndexTask : public PerfTask
{
  GET_CLASS_NAME(CloseIndexTask)

public:
  CloseIndexTask(std::shared_ptr<PerfRunData> runData);
...
protected:
  std::shared_ptr<CloseIndexTask> shared_from_this()
  {
    return std::static_pointer_cast<CloseIndexTask>(
