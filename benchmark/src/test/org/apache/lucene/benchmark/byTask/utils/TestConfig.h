...
class TestConfig : public LuceneTestCase
{
  GET_CLASS_NAME(TestConfig)

public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testAbsolutePathNamesWindows() throws
  // Exception
  virtual void testAbsolutePathNamesWindows() ;

protected:
  std::shared_ptr<TestConfig> shared_from_this()
  {
    return std::static_pointer_cast<TestConfig>(
