...
class ExpressionAggregationFacetsExample
    : public std::enable_shared_from_this<ExpressionAggregationFacetsExample>
{
  GET_CLASS_NAME(ExpressionAggregationFacetsExample)
...
private:
  ...
  std::shared_ptr<FacetResult> search() ;

  /** Runs the search example. */
public:
  virtual std::shared_ptr<FacetResult> runSearch() throw(IOException,
                                                         ParseException);
