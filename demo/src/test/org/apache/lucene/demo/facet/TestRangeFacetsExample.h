...
class TestRangeFacetsExample : public LuceneTestCase
{
  GET_CLASS_NAME(TestRangeFacetsExample)
...
protected:
  std::shared_ptr<TestRangeFacetsExample> shared_from_this()
  {
    return std::static_pointer_cast<TestRangeFacetsExample>(
