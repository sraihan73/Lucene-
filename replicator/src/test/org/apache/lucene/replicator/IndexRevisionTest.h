...
class IndexRevisionTest : public ReplicatorTestCase
{
  GET_CLASS_NAME(IndexRevisionTest)

public:
  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testNoSnapshotDeletionPolicy() throws
  // Exception
  virtual void testNoSnapshotDeletionPolicy() ;
...
protected:
  std::shared_ptr<IndexRevisionTest> shared_from_this()
  {
    return std::static_pointer_cast<IndexRevisionTest>(
