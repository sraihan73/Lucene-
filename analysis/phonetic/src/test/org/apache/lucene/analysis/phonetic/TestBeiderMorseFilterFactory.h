...
class TestBeiderMorseFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestBeiderMorseFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestBeiderMorseFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestBeiderMorseFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestBeiderMorseFilterFactory>(
