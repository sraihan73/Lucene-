 ...
 */
class TestStempelPolishStemFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestStempelPolishStemFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestStempelPolishStemFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestStempelPolishStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestStempelPolishStemFilterFactory>(
