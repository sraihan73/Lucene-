 ...
 */
class UkrainianMorfologikAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(UkrainianMorfologikAnalyzer)
private:
...
public:
   ...
   */
  UkrainianMorfologikAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
private:
  static std::shared_ptr<Dictionary> getDictionary();

protected:
  std::shared_ptr<UkrainianMorfologikAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<UkrainianMorfologikAnalyzer>(
