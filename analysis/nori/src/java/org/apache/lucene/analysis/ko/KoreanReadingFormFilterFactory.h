 ...
 * @lucene.experimental
 */
class KoreanReadingFormFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(KoreanReadingFormFilterFactory)
...
protected:
  std::shared_ptr<KoreanReadingFormFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<KoreanReadingFormFilterFactory>(
