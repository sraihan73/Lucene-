...
const wstring CharacterDefinition::HEADER = L"ko_cd";
...
bool CharacterDefinition::isHanja(wchar_t c)
{
  constexpr char characterClass = getCharacterClass(c);
  return characterClass == HANJA || characterClass == HANJANUMERIC;
}

bool CharacterDefinition::isHangul(wchar_t c)
{
  return getCharacterClass(c) == HANGUL;
}

bool CharacterDefinition::hasCoda(wchar_t ch)
{
