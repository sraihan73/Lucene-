...
public:
  ...
  static const char HANGUL =
      static_cast<char>(static_cast<int>(CharacterClass::HANGUL));
  static const char HANJA =
      static_cast<char>(static_cast<int>(CharacterClass::HANJA));
  static const char HANJANUMERIC =
      static_cast<char>(static_cast<int>(CharacterClass::HANJANUMERIC));
...
public:
  ...
  bool isHanja(wchar_t c);

  bool isHangul(wchar_t c);

  bool hasCoda(wchar_t ch);
