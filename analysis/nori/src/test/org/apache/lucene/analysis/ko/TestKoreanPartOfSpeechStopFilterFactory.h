 ...
 */
class TestKoreanPartOfSpeechStopFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestKoreanPartOfSpeechStopFilterFactory)
public:
  virtual void testStopTags() ;
...
private:
  ...
  private:
    std::shared_ptr<TestKoreanPartOfSpeechStopFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestKoreanPartOfSpeechStopFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestKoreanPartOfSpeechStopFilterFactory>(
