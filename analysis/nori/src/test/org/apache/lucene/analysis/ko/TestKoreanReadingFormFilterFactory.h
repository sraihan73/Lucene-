 ...
 */
class TestKoreanReadingFormFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestKoreanReadingFormFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestKoreanReadingFormFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestKoreanReadingFormFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestKoreanReadingFormFilterFactory>(
