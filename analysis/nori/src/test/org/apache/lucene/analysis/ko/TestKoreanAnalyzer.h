 ...
 */
class TestKoreanAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestKoreanAnalyzer)
public:
  virtual void testSentence() ;
...
protected:
  std::shared_ptr<TestKoreanAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestKoreanAnalyzer>(
