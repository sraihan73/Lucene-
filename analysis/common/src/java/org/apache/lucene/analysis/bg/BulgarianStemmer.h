 ...
 */
class BulgarianStemmer : public std::enable_shared_from_this<BulgarianStemmer>
{
  GET_CLASS_NAME(BulgarianStemmer)
...
public:
   ...
   */
private:
  int removeArticle(std::deque<wchar_t> &s, int const len);
