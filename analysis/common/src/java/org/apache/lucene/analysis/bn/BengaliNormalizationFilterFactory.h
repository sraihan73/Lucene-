 ...
 * &lt;fieldType name="text_bnnormal" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.StandardTokenizerFactory"/&gt; &lt;filter
 * class="solr.BengaliNormalizationFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * @since 7.1.0
 */
class BengaliNormalizationFilterFactory : public TokenFilterFactory,
                                          public MultiTermAwareComponent
{
  GET_CLASS_NAME(BengaliNormalizationFilterFactory)
...
protected:
  std::shared_ptr<BengaliNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<BengaliNormalizationFilterFactory>(
