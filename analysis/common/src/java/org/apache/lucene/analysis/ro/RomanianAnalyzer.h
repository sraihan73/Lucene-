 ...
 */
class RomanianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(RomanianAnalyzer)
private:
...
public:
   ...
   */
  RomanianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<RomanianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<RomanianAnalyzer>(
        org.apache.lucene.analysis.StopwordAnalyzerBase::shared_from_this());
  }
};

} // #include  "core/src/java/org/apache/lucene/analysis/ro/
