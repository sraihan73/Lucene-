 ...
 * Analyzer for Hindi.
 */
class HindiAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(HindiAnalyzer)
private:
...
private:
   ...
   */
public:
  HindiAnalyzer(std::shared_ptr<CharArraySet> stopwords,
...
protected:
  std::shared_ptr<HindiAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<HindiAnalyzer>(
