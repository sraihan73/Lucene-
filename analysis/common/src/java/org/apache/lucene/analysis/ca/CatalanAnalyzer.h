 ...
 */
class CatalanAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(CatalanAnalyzer)
private:
...
public:
   ...
   */
  CatalanAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<CatalanAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<CatalanAnalyzer>(
        org.apache.lucene.analysis.StopwordAnalyzerBase::shared_from_this());
  }
};

} // #include  "core/src/java/org/apache/lucene/analysis/ca/
