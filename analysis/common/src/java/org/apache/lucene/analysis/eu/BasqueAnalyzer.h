 ...
 */
class BasqueAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(BasqueAnalyzer)
private:
...
public:
   ...
   */
  BasqueAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<BasqueAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<BasqueAnalyzer>(
