 ...
 */
class SpanishAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(SpanishAnalyzer)
private:
...
public:
   ...
   */
  SpanishAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<SpanishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<SpanishAnalyzer>(
