 ...
 */
class LithuanianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(LithuanianAnalyzer)
private:
...
public:
   ...
   */
  LithuanianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<LithuanianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<LithuanianAnalyzer>(
