 ...
 * &lt;fieldType name="text_ascii" class="solr.TextField"
...
{
  GET_CLASS_NAME(ASCIIFoldingFilterFactory)
private:
  static const std::wstring PRESERVE_ORIGINAL;
...
public:
  ...
  std::shared_ptr<ASCIIFoldingFilter>
  create(std::shared_ptr<TokenStream> input) override;

  std::shared_ptr<AbstractAnalysisFactory> getMultiTermComponent() override;

protected:
  std::shared_ptr<ASCIIFoldingFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<ASCIIFoldingFilterFactory>(
