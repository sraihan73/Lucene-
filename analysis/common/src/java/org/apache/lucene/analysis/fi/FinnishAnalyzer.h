 ...
 */
class FinnishAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(FinnishAnalyzer)
private:
...
public:
   ...
   */
  FinnishAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<FinnishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<FinnishAnalyzer>(
