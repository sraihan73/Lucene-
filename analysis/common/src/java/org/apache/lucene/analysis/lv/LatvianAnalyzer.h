 ...
 */
class LatvianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(LatvianAnalyzer)
private:
...
public:
   ...
   */
  LatvianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<LatvianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<LatvianAnalyzer>(
