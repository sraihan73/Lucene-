...
#include "SynonymGraphFilterFactory.h"
#include "../../../../../../../../../core/src/java/org/apache/lucene/analysis/TokenStream.h"
#include "../../../../../../../../../core/src/java/org/apache/lucene/analysis/Tokenizer.h"
#include "../core/LowerCaseFilter.h"
...
SynonymGraphFilterFactory::SynonymGraphFilterFactory(
...
SynonymGraphFilterFactory::create(shared_ptr<TokenStream> input)
{
  ...
  return map_obj->fst == nullptr
             ? input
             : make_shared<SynonymGraphFilter>(input, map_obj, ignoreCase);
}

void SynonymGraphFilterFactory::inform(shared_ptr<ResourceLoader> loader) throw(
    IOException)
{
...
SynonymGraphFilterFactory::AnalyzerAnonymousInnerClass::
    AnalyzerAnonymousInnerClass(
        shared_ptr<SynonymGraphFilterFactory> outerInstance,
...
SynonymGraphFilterFactory::AnalyzerAnonymousInnerClass::createComponents(
...
shared_ptr<SynonymMap> SynonymGraphFilterFactory::loadSynonyms(
    ...
    shared_ptr<Analyzer> analyzer) 
{
  ...
  for (auto file : files) {
    decoder->reset();
    parser->parse(
        make_shared<InputStreamReader>(loader->openResource(file), decoder));
  }
  return parser->build();
}

shared_ptr<TokenizerFactory> SynonymGraphFilterFactory::loadTokenizerFactory(
...
shared_ptr<Analyzer>
SynonymGraphFilterFactory::loadAnalyzer(shared_ptr<ResourceLoader> loader,
                                        const wstring &cname) 
{
