...
#include  "core/src/java/org/apache/lucene/analysis/br/BrazilianStemFilter.h"
 ...
 * &lt;fieldType name="text_brstem" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.StandardTokenizerFactory"/&gt; &lt;filter
 * class="solr.LowerCaseFilterFactory"/&gt; &lt;filter
 * class="solr.BrazilianStemFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 */
class BrazilianStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(BrazilianStemFilterFactory)
...
public:
  ...
  std::shared_ptr<BrazilianStemFilter>
  create(std::shared_ptr<TokenStream> in_) override;

protected:
  std::shared_ptr<BrazilianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<BrazilianStemFilterFactory>(
