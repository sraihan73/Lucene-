 ...
 * @since 3.6.0
 */
class NorwegianLightStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(NorwegianLightStemFilterFactory)
...
protected:
  std::shared_ptr<NorwegianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<NorwegianLightStemFilterFactory>(
