 ...
 * &lt;fieldType name="text_innormal" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.StandardTokenizerFactory"/&gt; &lt;filter
 * class="solr.IndicNormalizationFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * @since 3.1.0
 */
class IndicNormalizationFilterFactory : public TokenFilterFactory,
                                        public MultiTermAwareComponent
{
  GET_CLASS_NAME(IndicNormalizationFilterFactory)
...
protected:
  std::shared_ptr<IndicNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<IndicNormalizationFilterFactory>(
