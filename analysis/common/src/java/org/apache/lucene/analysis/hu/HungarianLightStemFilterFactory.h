 ...
 * &lt;fieldType name="text_hulgtstem" class="solr.TextField"
 ...
 * @since 3.1.0
 */
class HungarianLightStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(HungarianLightStemFilterFactory)
...
protected:
  std::shared_ptr<HungarianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<HungarianLightStemFilterFactory>(
