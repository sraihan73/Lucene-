...
const wstring PortugueseAnalyzer::DEFAULT_STOPWORD_FILE =
    L"portuguese_stop.txt";

shared_ptr<CharArraySet> PortugueseAnalyzer::getDefaultStopSet()
{
...
PortugueseAnalyzer::DefaultSetHolder::StaticConstructor::StaticConstructor()
{
  try {
    DEFAULT_STOP_SET =
...
DefaultSetHolder::StaticConstructor
    PortugueseAnalyzer::DefaultSetHolder::staticConstructor;
...
PortugueseAnalyzer::PortugueseAnalyzer(shared_ptr<CharArraySet> stopwords)
    : PortugueseAnalyzer(stopwords, CharArraySet::EMPTY_SET)
{
}
...
PortugueseAnalyzer::createComponents(const wstring &fieldName)
{
  ...
  result = make_shared<PortugueseLightStemFilter>(result);
  return make_shared<Analyzer::TokenStreamComponents>(source, result);
}

shared_ptr<TokenStream>
PortugueseAnalyzer::normalize(const wstring &fieldName,
