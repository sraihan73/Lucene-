 ...
 */
class HungarianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(HungarianAnalyzer)
private:
...
public:
   ...
   */
  HungarianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<HungarianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<HungarianAnalyzer>(
