...
#include  "core/src/java/org/apache/lucene/analysis/ar/ArabicNormalizationFilter.h"
 ...
 * class="solr.ArabicNormalizationFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 */
class ArabicNormalizationFilterFactory : public TokenFilterFactory,
                                         public MultiTermAwareComponent
{
  GET_CLASS_NAME(ArabicNormalizationFilterFactory)
...
public:
  ...
  std::shared_ptr<ArabicNormalizationFilter>
  create(std::shared_ptr<TokenStream> input) override;

  std::shared_ptr<AbstractAnalysisFactory> getMultiTermComponent() override;

protected:
  std::shared_ptr<ArabicNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<ArabicNormalizationFilterFactory>(
