 ...
 * &lt;fieldType name="text_denorm" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.StandardTokenizerFactory"/&gt; &lt;filter
 * class="solr.LowerCaseFilterFactory"/&gt; &lt;filter
 * class="solr.GermanNormalizationFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * @since 3.6.0
 */
class GermanNormalizationFilterFactory : public TokenFilterFactory,
                                         public MultiTermAwareComponent
{
  GET_CLASS_NAME(GermanNormalizationFilterFactory)
...
protected:
  std::shared_ptr<GermanNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<GermanNormalizationFilterFactory>(
