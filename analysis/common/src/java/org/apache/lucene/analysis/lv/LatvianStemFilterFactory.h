 ...
 * &lt;fieldType name="text_lvstem" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.StandardTokenizerFactory"/&gt; &lt;filter
 * class="solr.LowerCaseFilterFactory"/&gt; &lt;filter
 * class="solr.LatvianStemFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * @since 3.2.0
 */
class LatvianStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(LatvianStemFilterFactory)
...
protected:
  std::shared_ptr<LatvianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<LatvianStemFilterFactory>(
