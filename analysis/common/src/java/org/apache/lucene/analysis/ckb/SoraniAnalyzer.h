 ...
 */
class SoraniAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(SoraniAnalyzer)
private:
...
public:
   ...
   */
  SoraniAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<SoraniAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<SoraniAnalyzer>(
