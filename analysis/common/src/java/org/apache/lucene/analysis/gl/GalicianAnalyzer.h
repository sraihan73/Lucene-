 ...
 */
class GalicianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(GalicianAnalyzer)
private:
...
public:
   ...
   */
  GalicianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<GalicianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<GalicianAnalyzer>(
