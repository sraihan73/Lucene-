 ...
 */
class NorwegianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(NorwegianAnalyzer)
private:
...
public:
   ...
   */
  NorwegianAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<NorwegianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<NorwegianAnalyzer>(
