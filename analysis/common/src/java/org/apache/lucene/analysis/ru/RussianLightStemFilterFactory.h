 ...
 * &lt;fieldType name="text_rulgtstem" class="solr.TextField"
 ...
 * @since 3.1.0
 */
class RussianLightStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(RussianLightStemFilterFactory)
...
protected:
  std::shared_ptr<RussianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<RussianLightStemFilterFactory>(
