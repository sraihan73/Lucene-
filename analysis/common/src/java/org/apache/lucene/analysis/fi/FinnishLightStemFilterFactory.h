 ...
 * &lt;fieldType name="text_filgtstem" class="solr.TextField"
 ...
 * @since 3.1.0
 */
class FinnishLightStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(FinnishLightStemFilterFactory)
...
protected:
  std::shared_ptr<FinnishLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<FinnishLightStemFilterFactory>(
