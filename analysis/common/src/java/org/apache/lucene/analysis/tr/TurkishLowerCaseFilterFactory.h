 ...
 * @since 3.1.0
 */
class TurkishLowerCaseFilterFactory : public TokenFilterFactory,
                                      public MultiTermAwareComponent
{
  GET_CLASS_NAME(TurkishLowerCaseFilterFactory)
...
protected:
  std::shared_ptr<TurkishLowerCaseFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TurkishLowerCaseFilterFactory>(
