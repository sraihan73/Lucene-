 ...
 * @since 3.1.0
 */
class SwedishLightStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(SwedishLightStemFilterFactory)
...
protected:
  std::shared_ptr<SwedishLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<SwedishLightStemFilterFactory>(
