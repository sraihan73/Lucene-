 ...
 */
class PortugueseAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(PortugueseAnalyzer)
private:
...
public:
   ...
   */
  PortugueseAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<PortugueseAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<PortugueseAnalyzer>(
