 ...
 */
class SwedishAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(SwedishAnalyzer)
private:
...
public:
   ...
   */
  SwedishAnalyzer(std::shared_ptr<CharArraySet> stopwords);
...
protected:
  std::shared_ptr<SwedishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<SwedishAnalyzer>(
