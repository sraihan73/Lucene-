 ...
 */
class PatternKeywordMarkerFilter final : public KeywordMarkerFilter
{
  GET_CLASS_NAME(PatternKeywordMarkerFilter)
private:
   ...
   **/
public:
  PatternKeywordMarkerFilter(std::shared_ptr<TokenStream> in_,
...
protected:
  std::shared_ptr<PatternKeywordMarkerFilter> shared_from_this()
  {
    return std::static_pointer_cast<PatternKeywordMarkerFilter>(
