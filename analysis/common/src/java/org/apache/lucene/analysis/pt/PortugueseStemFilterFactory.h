 ...
 * &lt;fieldType name="text_ptstem" class="solr.TextField"
 ...
 * @since 3.1.0
 */
class PortugueseStemFilterFactory : public TokenFilterFactory
{
  GET_CLASS_NAME(PortugueseStemFilterFactory)
...
protected:
  std::shared_ptr<PortugueseStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<PortugueseStemFilterFactory>(
