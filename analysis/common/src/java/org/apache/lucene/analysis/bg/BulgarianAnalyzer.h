 ...
 */
class BulgarianAnalyzer final : public StopwordAnalyzerBase
{
  GET_CLASS_NAME(BulgarianAnalyzer)
...
public:
   ...
   */
  BulgarianAnalyzer(std::shared_ptr<CharArraySet> stopwords);

  /**
   * Builds an analyzer with the given stop words and a stem exclusion set.
   * If a stem exclusion set is provided this analyzer will add a {@link
   * SetKeywordMarkerFilter} before {@link BulgarianStemFilter}.
   */
  BulgarianAnalyzer(std::shared_ptr<CharArraySet> stopwords,
...
protected:
  std::shared_ptr<BulgarianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<BulgarianAnalyzer>(
