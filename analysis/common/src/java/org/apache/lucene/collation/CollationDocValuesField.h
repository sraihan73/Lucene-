 ...
 */
class CollationDocValuesField final : public Field
{
  GET_CLASS_NAME(CollationDocValuesField)
private:
  ...
  // instead?
public:
  CollationDocValuesField(const std::wstring &name,
...
protected:
  std::shared_ptr<CollationDocValuesField> shared_from_this()
  {
    return std::static_pointer_cast<CollationDocValuesField>(
