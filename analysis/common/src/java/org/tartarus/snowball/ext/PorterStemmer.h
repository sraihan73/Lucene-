...
// ORIGINAL LINE: @SuppressWarnings("unused") public class PorterStemmer extends
// org.tartarus.snowball.SnowballProgram
class PorterStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<PorterStemmer> other);
...
protected:
  std::shared_ptr<PorterStemmer> shared_from_this()
  {
    return std::static_pointer_cast<PorterStemmer>(
