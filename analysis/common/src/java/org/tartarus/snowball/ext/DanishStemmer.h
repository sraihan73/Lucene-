...
// ORIGINAL LINE: @SuppressWarnings("unused") public class DanishStemmer extends
// org.tartarus.snowball.SnowballProgram
class DanishStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<DanishStemmer> other);
...
protected:
  std::shared_ptr<DanishStemmer> shared_from_this()
  {
    return std::static_pointer_cast<DanishStemmer>(
