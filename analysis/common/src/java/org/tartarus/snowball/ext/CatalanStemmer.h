...
// ORIGINAL LINE: @SuppressWarnings("unused") public class CatalanStemmer
// extends org.tartarus.snowball.SnowballProgram
class CatalanStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<CatalanStemmer> other);
...
protected:
  std::shared_ptr<CatalanStemmer> shared_from_this()
  {
    return std::static_pointer_cast<CatalanStemmer>(
