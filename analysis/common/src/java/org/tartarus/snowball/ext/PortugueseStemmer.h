...
// ORIGINAL LINE: @SuppressWarnings("unused") public class PortugueseStemmer
// extends org.tartarus.snowball.SnowballProgram
class PortugueseStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<PortugueseStemmer> other);
