...
// ORIGINAL LINE: @SuppressWarnings("unused") public class GermanStemmer extends
// org.tartarus.snowball.SnowballProgram
class GermanStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<GermanStemmer> other);
...
protected:
  std::shared_ptr<GermanStemmer> shared_from_this()
  {
    return std::static_pointer_cast<GermanStemmer>(
