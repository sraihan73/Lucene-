...
// ORIGINAL LINE: @SuppressWarnings("unused") public class RussianStemmer
// extends org.tartarus.snowball.SnowballProgram
class RussianStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<RussianStemmer> other);
...
protected:
  std::shared_ptr<RussianStemmer> shared_from_this()
  {
    return std::static_pointer_cast<RussianStemmer>(
