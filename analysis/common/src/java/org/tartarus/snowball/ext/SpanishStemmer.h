...
// ORIGINAL LINE: @SuppressWarnings("unused") public class SpanishStemmer
// extends org.tartarus.snowball.SnowballProgram
class SpanishStemmer : public SnowballProgram
{
...
private:
  ...
  void copy_from(std::shared_ptr<SpanishStemmer> other);
...
protected:
  std::shared_ptr<SpanishStemmer> shared_from_this()
  {
    return std::static_pointer_cast<SpanishStemmer>(
