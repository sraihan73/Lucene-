...
// ORIGINAL LINE: @SuppressWarnings("unused") public class FrenchStemmer extends
// org.tartarus.snowball.SnowballProgram
class FrenchStemmer : public SnowballProgram
{
...
private:
  ...
  static std::deque<wchar_t> const g_keep_with_s;

  int I_p2 = 0;
  int I_p1 = 0;
  int I_pV = 0;

  void copy_from(std::shared_ptr<FrenchStemmer> other);
...
protected:
  std::shared_ptr<FrenchStemmer> shared_from_this()
  {
    return std::static_pointer_cast<FrenchStemmer>(
