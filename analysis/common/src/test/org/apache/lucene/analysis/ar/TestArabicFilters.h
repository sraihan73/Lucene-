 ...
 */
class TestArabicFilters : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestArabicFilters)

  /**
   * Test ArabicNormalizationFilterFactory
   */
public:
  virtual void testNormalizer() ;
   ...
   */
  virtual void testPersianCharFilter() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestArabicFilters> shared_from_this()
  {
    return std::static_pointer_cast<TestArabicFilters>(
