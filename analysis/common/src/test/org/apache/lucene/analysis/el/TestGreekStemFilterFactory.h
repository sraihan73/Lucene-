 ...
 */
class TestGreekStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGreekStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestGreekStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGreekStemFilterFactory>(
