...
class TestTurkishAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestTurkishAnalyzer)
...
protected:
  std::shared_ptr<TestTurkishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestTurkishAnalyzer>(
