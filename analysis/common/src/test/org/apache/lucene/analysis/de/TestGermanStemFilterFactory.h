 ...
 */
class TestGermanStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGermanStemFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestGermanStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanStemFilterFactory>(
