 ...
 */
class TestFrenchLightStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestFrenchLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestFrenchLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestFrenchLightStemFilterFactory>(
