 ...
 */
class TestGalicianStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGalicianStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestGalicianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGalicianStemFilterFactory>(
