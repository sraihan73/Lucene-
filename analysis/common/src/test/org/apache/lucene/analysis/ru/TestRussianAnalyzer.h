...
class TestRussianAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestRussianAnalyzer)

  /** Check that RussianAnalyzer doesnt discard any numbers */
public:
  virtual void testDigitsInRussianCharset() ;
...
protected:
  std::shared_ptr<TestRussianAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestRussianAnalyzer>(
