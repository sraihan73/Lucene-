 ...
 */
class TestFinnishLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestFinnishLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestFinnishLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestFinnishLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestFinnishLightStemFilter>(
