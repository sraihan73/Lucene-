 ...
 */
class TestGalicianMinimalStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestGalicianMinimalStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestGalicianMinimalStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestGalicianMinimalStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestGalicianMinimalStemFilter>(
