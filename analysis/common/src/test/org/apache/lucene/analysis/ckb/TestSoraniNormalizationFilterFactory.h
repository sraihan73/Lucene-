 ...
 */
class TestSoraniNormalizationFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestSoraniNormalizationFilterFactory)
...
protected:
  std::shared_ptr<TestSoraniNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestSoraniNormalizationFilterFactory>(
