 ...
 *
 */
class TestGermanStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestGermanStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestGermanStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestGermanStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanStemFilter>(
