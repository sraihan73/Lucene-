 ...
 */
class TestTurkishLowerCaseFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestTurkishLowerCaseFilterFactory)
  /**
   * Ensure the filter actually lowercases text.
   */
public:
  virtual void testCasing() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestTurkishLowerCaseFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestTurkishLowerCaseFilterFactory>(
