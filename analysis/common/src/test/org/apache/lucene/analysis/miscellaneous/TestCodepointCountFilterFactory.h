...
class TestCodepointCountFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestCodepointCountFilterFactory)
...
protected:
  std::shared_ptr<TestCodepointCountFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestCodepointCountFilterFactory>(
