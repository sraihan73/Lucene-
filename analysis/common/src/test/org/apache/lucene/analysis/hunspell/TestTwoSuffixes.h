...
class TestTwoSuffixes : public StemmerTestBase
{
  GET_CLASS_NAME(TestTwoSuffixes)
...
protected:
  std::shared_ptr<TestTwoSuffixes> shared_from_this()
  {
    return std::static_pointer_cast<TestTwoSuffixes>(
