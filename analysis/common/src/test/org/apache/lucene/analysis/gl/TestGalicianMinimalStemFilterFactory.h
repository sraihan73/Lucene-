 ...
 */
class TestGalicianMinimalStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGalicianMinimalStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestGalicianMinimalStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGalicianMinimalStemFilterFactory>(
