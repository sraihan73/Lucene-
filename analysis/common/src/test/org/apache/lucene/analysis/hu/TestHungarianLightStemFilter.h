 ...
 */
class TestHungarianLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestHungarianLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestHungarianLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestHungarianLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestHungarianLightStemFilter>(
