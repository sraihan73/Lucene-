 ...
 */
class TestCzechStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestCzechStemFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestCzechStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestCzechStemFilterFactory>(
