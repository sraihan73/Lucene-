...
class TestEnglishAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestEnglishAnalyzer)
...
protected:
  std::shared_ptr<TestEnglishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestEnglishAnalyzer>(
