 ...
 */
class TestApostropheFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestApostropheFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestApostropheFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestApostropheFilterFactory>(
