...
class TestFlagNum : public StemmerTestBase
{
  GET_CLASS_NAME(TestFlagNum)
public:
  ...
  virtual void testNumFlags();

protected:
  std::shared_ptr<TestFlagNum> shared_from_this()
  {
    return std::static_pointer_cast<TestFlagNum>(
