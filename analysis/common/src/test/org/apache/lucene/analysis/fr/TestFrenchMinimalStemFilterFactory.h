 ...
 */
class TestFrenchMinimalStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestFrenchMinimalStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestFrenchMinimalStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestFrenchMinimalStemFilterFactory>(
