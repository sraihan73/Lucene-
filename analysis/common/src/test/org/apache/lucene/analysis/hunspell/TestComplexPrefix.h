...
class TestComplexPrefix : public StemmerTestBase
{
  GET_CLASS_NAME(TestComplexPrefix)
public:
...
protected:
  std::shared_ptr<TestComplexPrefix> shared_from_this()
  {
    return std::static_pointer_cast<TestComplexPrefix>(
