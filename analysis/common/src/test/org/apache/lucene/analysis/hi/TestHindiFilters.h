 ...
 */
class TestHindiFilters : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestHindiFilters)
  /**
...
public:
   ...
   */
  virtual void testHindiNormalizer() ;
...
protected:
  std::shared_ptr<TestHindiFilters> shared_from_this()
  {
    return std::static_pointer_cast<TestHindiFilters>(
