 ...
 */
class TestPortugueseMinimalStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPortugueseMinimalStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestPortugueseMinimalStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPortugueseMinimalStemFilterFactory>(
