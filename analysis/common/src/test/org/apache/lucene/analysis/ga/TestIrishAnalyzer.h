...
class TestIrishAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestIrishAnalyzer)
...
public:
  ...
  virtual void testHyphens() ;

  /** blast some random strings through the analyzer */
  virtual void testRandomStrings() ;

protected:
  std::shared_ptr<TestIrishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestIrishAnalyzer>(
