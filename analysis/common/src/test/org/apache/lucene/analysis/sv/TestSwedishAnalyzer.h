...
class TestSwedishAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestSwedishAnalyzer)
...
protected:
  std::shared_ptr<TestSwedishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestSwedishAnalyzer>(
