 ...
 */
class TestPatternReplaceCharFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPatternReplaceCharFilterFactory)
...
protected:
  std::shared_ptr<TestPatternReplaceCharFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPatternReplaceCharFilterFactory>(
