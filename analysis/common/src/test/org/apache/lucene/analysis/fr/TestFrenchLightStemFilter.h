 ...
 */
class TestFrenchLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestFrenchLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestFrenchLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestFrenchLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestFrenchLightStemFilter>(
