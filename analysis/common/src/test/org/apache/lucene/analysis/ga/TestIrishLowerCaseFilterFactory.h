 ...
 */
class TestIrishLowerCaseFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestIrishLowerCaseFilterFactory)
public:
...
protected:
  std::shared_ptr<TestIrishLowerCaseFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestIrishLowerCaseFilterFactory>(
