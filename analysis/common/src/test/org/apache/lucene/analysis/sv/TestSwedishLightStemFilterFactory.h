 ...
 */
class TestSwedishLightStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestSwedishLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestSwedishLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestSwedishLightStemFilterFactory>(
