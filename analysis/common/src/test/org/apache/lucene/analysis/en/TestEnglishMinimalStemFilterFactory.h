 ...
 */
class TestEnglishMinimalStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestEnglishMinimalStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestEnglishMinimalStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestEnglishMinimalStemFilterFactory>(
