 ...
 */
class TestNorwegianMinimalStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestNorwegianMinimalStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestNorwegianMinimalStemFilter> outerInstance;
...
public:
  ...
  virtual void testNynorskVocabulary() ;
...
protected:
  std::shared_ptr<TestNorwegianMinimalStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestNorwegianMinimalStemFilter>(
