 ...
 */
class TestNorwegianLightStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestNorwegianLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestNorwegianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestNorwegianLightStemFilterFactory>(
