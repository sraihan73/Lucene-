 ...
 */
class TestFrenchMinimalStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestFrenchMinimalStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestFrenchMinimalStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestFrenchMinimalStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestFrenchMinimalStemFilter>(
