...
class TestMorphData : public StemmerTestBase
{
  GET_CLASS_NAME(TestMorphData)
...
protected:
  std::shared_ptr<TestMorphData> shared_from_this()
  {
    return std::static_pointer_cast<TestMorphData>(
