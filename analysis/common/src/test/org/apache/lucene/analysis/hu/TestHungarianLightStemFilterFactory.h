 ...
 */
class TestHungarianLightStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestHungarianLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestHungarianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestHungarianLightStemFilterFactory>(
