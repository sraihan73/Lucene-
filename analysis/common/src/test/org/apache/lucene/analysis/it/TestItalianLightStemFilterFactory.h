 ...
 */
class TestItalianLightStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestItalianLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestItalianLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestItalianLightStemFilterFactory>(
