 ...
 */
class EdgeNGramTokenizerTest : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(EdgeNGramTokenizerTest)
private:
...
private:
  ...
  private:
    std::shared_ptr<EdgeNGramTokenizerTest> outerInstance;
  ...
  public:
    AnalyzerAnonymousInnerClass(
        std::shared_ptr<EdgeNGramTokenizerTest> outerInstance, int min,
        int max);
...
public:
  virtual void testTokenizerPositions() ;
...
protected:
  std::shared_ptr<EdgeNGramTokenizerTest> shared_from_this()
  {
    return std::static_pointer_cast<EdgeNGramTokenizerTest>(
