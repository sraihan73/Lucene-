 ...
 */
class TestCJKWidthFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestCJKWidthFilterFactory)
public:
  virtual void test() ;
...
protected:
  std::shared_ptr<TestCJKWidthFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestCJKWidthFilterFactory>(
