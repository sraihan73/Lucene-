 ...
 */
class TestGermanLightStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGermanLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestGermanLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanLightStemFilterFactory>(
