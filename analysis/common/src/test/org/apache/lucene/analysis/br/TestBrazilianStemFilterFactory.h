 ...
 */
class TestBrazilianStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestBrazilianStemFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestBrazilianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestBrazilianStemFilterFactory>(
