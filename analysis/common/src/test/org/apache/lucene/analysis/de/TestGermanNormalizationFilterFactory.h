 ...
 */
class TestGermanNormalizationFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGermanNormalizationFilterFactory)
public:
...
protected:
  std::shared_ptr<TestGermanNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanNormalizationFilterFactory>(
