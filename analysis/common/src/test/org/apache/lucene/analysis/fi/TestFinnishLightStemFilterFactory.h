 ...
 */
class TestFinnishLightStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestFinnishLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestFinnishLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestFinnishLightStemFilterFactory>(
