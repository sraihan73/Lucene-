 ...
 */
class TestPortugueseLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestPortugueseLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestPortugueseLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestPortugueseLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestPortugueseLightStemFilter>(
