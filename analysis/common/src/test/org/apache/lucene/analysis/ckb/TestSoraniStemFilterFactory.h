 ...
 */
class TestSoraniStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestSoraniStemFilterFactory)
...
protected:
  std::shared_ptr<TestSoraniStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestSoraniStemFilterFactory>(
