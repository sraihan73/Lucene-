 ...
 */
class TestDecimalDigitFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestDecimalDigitFilterFactory)
...
protected:
  std::shared_ptr<TestDecimalDigitFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestDecimalDigitFilterFactory>(
