 ...
 */
class TestNorwegianLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestNorwegianLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestNorwegianLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestNorwegianLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestNorwegianLightStemFilter>(
