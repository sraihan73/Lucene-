...
class TestEscaped : public StemmerTestBase
{
  GET_CLASS_NAME(TestEscaped)
public:
...
protected:
  std::shared_ptr<TestEscaped> shared_from_this()
  {
    return std::static_pointer_cast<TestEscaped>(
