 ...
 */
class TestPorterStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPorterStemFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestPorterStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPorterStemFilterFactory>(
