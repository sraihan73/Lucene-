...
class TestFrenchAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestFrenchAnalyzer)
...
public:
  ...
  virtual void testAccentInsensitive() ;

protected:
  std::shared_ptr<TestFrenchAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestFrenchAnalyzer>(
