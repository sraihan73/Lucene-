 ...
 */
class TestGreekLowerCaseFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestGreekLowerCaseFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestGreekLowerCaseFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestGreekLowerCaseFilterFactory>(
