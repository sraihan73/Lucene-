...
class TestFinnishAnalyzer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestFinnishAnalyzer)
...
protected:
  std::shared_ptr<TestFinnishAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestFinnishAnalyzer>(
