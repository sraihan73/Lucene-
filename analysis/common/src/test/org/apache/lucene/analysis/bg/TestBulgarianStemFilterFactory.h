 ...
 */
class TestBulgarianStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestBulgarianStemFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestBulgarianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestBulgarianStemFilterFactory>(
