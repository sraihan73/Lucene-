...
class TestDoubleEscape : public StemmerTestBase
{
  GET_CLASS_NAME(TestDoubleEscape)
public:
...
protected:
  std::shared_ptr<TestDoubleEscape> shared_from_this()
  {
    return std::static_pointer_cast<TestDoubleEscape>(
