...
class TestLengthFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestLengthFilter)
...
private:
  ...
  private:
    std::shared_ptr<TestLengthFilter> outerInstance;
...
protected:
  std::shared_ptr<TestLengthFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestLengthFilter>(
