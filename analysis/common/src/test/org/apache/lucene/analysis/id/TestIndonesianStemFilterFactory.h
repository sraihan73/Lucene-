 ...
 */
class TestIndonesianStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestIndonesianStemFilterFactory)
  /**
...
public:
   ...
   */
  virtual void testStemmingInflectional() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestIndonesianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestIndonesianStemFilterFactory>(
