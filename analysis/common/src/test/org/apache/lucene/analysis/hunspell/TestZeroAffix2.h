...
class TestZeroAffix2 : public StemmerTestBase
{
  GET_CLASS_NAME(TestZeroAffix2)
...
protected:
  std::shared_ptr<TestZeroAffix2> shared_from_this()
  {
    return std::static_pointer_cast<TestZeroAffix2>(
