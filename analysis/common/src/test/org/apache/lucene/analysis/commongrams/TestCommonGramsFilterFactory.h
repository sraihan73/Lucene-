 ...
 **/
class TestCommonGramsFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestCommonGramsFilterFactory)
...
protected:
  std::shared_ptr<TestCommonGramsFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestCommonGramsFilterFactory>(
