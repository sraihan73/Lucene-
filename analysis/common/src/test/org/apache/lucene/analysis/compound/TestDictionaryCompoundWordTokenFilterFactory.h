 ...
 */
class TestDictionaryCompoundWordTokenFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestDictionaryCompoundWordTokenFilterFactory)
  /**
   * Ensure the filter actually decompounds text.
   */
public:
  virtual void testDecompounding() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestDictionaryCompoundWordTokenFilterFactory>
  shared_from_this()
  {
