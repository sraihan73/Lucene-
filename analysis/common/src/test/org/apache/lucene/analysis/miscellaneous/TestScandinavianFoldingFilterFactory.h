...
class TestScandinavianFoldingFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestScandinavianFoldingFilterFactory)
...
protected:
  std::shared_ptr<TestScandinavianFoldingFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestScandinavianFoldingFilterFactory>(
