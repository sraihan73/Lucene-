 ...
 */
class TestSwedishLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestSwedishLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestSwedishLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestSwedishLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestSwedishLightStemFilter>(
