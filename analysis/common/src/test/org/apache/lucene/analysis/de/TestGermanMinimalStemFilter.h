 ...
 */
class TestGermanMinimalStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestGermanMinimalStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestGermanMinimalStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestGermanMinimalStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanMinimalStemFilter>(
