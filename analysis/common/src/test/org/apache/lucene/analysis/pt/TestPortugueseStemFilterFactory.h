 ...
 */
class TestPortugueseStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPortugueseStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestPortugueseStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPortugueseStemFilterFactory>(
