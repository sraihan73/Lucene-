 ...
 *
 */
class GreekAnalyzerTest : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(GreekAnalyzerTest)
...
protected:
  std::shared_ptr<GreekAnalyzerTest> shared_from_this()
  {
    return std::static_pointer_cast<GreekAnalyzerTest>(
