 ...
 */
class TestPersianNormalizationFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPersianNormalizationFilterFactory)
  /**
...
protected:
  std::shared_ptr<TestPersianNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPersianNormalizationFilterFactory>(
