 ...
 */
class TestSerbianNormalizationFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestSerbianNormalizationFilterFactory)
public:
  virtual void testStemming() ;

  virtual void testRegularStemming() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestSerbianNormalizationFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestSerbianNormalizationFilterFactory>(
