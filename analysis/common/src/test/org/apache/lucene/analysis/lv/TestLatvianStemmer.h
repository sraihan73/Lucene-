 ...
 */
class TestLatvianStemmer : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestLatvianStemmer)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestLatvianStemmer> outerInstance;
...
public:
   ...
   */
  virtual void testNouns2() ;

  virtual void testNouns3() ;

  virtual void testNouns4() ;

  /**
   * Genitive plural forms with (s,t) -&gt; š and (d,z) -&gt; ž
   * will not conflate due to ambiguity.
   */
  virtual void testNouns5() ;

  virtual void testNouns6() ;
   ...
   * (s,t) -&gt; š and (d,z) -&gt; ž
   */
  virtual void testPalatalization() ;
...
protected:
  std::shared_ptr<TestLatvianStemmer> shared_from_this()
  {
    return std::static_pointer_cast<TestLatvianStemmer>(
