 ...
 * @since solr 1.4
 */
class TestMultiWordSynonyms : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestMultiWordSynonyms)

public:
  virtual void testMultiWordSynonyms() ;

protected:
  std::shared_ptr<TestMultiWordSynonyms> shared_from_this()
  {
    return std::static_pointer_cast<TestMultiWordSynonyms>(
