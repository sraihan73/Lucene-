 ...
 */
class TestPortugueseLightStemFilterFactory
    : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestPortugueseLightStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestPortugueseLightStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestPortugueseLightStemFilterFactory>(
