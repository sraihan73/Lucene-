...
class TestSnowballPorterFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestSnowballPorterFilterFactory)
...
public:
   ...
   */
  virtual void testProtected() ;

  /** Test that bogus arguments result in exception */
  virtual void testBogusArguments() ;

protected:
  std::shared_ptr<TestSnowballPorterFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestSnowballPorterFilterFactory>(
