 ...
 */
class TestGermanLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestGermanLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestGermanLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestGermanLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestGermanLightStemFilter>(
