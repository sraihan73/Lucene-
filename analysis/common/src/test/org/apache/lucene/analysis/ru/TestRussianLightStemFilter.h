 ...
 */
class TestRussianLightStemFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestRussianLightStemFilter)
private:
...
private:
  ...
  private:
    std::shared_ptr<TestRussianLightStemFilter> outerInstance;
...
protected:
  std::shared_ptr<TestRussianLightStemFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestRussianLightStemFilter>(
