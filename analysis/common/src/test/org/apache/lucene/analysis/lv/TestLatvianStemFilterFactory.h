 ...
 */
class TestLatvianStemFilterFactory : public BaseTokenStreamFactoryTestCase
{
  GET_CLASS_NAME(TestLatvianStemFilterFactory)
public:
...
protected:
  std::shared_ptr<TestLatvianStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestLatvianStemFilterFactory>(
