 ...
 */
class TestHMMChineseTokenizerFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestHMMChineseTokenizerFactory)
...
private:
  ...
  private:
    std::shared_ptr<TestHMMChineseTokenizerFactory> outerInstance;
...
protected:
  std::shared_ptr<TestHMMChineseTokenizerFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestHMMChineseTokenizerFactory>(
