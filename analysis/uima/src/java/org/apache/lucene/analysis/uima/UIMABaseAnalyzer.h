...
/**
 * An {@link Analyzer} which use the {@link UIMAAnnotationsTokenizer} for
 * creating tokens
 */
class UIMABaseAnalyzer final : public Analyzer
{
  GET_CLASS_NAME(UIMABaseAnalyzer)
...
protected:
  std::shared_ptr<UIMABaseAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<UIMABaseAnalyzer>(
