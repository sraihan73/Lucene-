...
class UnknownDictionaryTest : public LuceneTestCase
{
  GET_CLASS_NAME(UnknownDictionaryTest)
public:
  static const std::wstring FILENAME;

  // C++ TODO: Most Java annotations will not have direct C++ equivalents:
  // ORIGINAL LINE: @Test public void testPutCharacterCategory()
  virtual void testPutCharacterCategory();
...
protected:
  std::shared_ptr<UnknownDictionaryTest> shared_from_this()
  {
    return std::static_pointer_cast<UnknownDictionaryTest>(
