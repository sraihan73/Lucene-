 ...
 */
class TestJapaneseReadingFormFilter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseReadingFormFilter)
private:
  std::shared_ptr<Analyzer> katakanaAnalyzer, romajiAnalyzer;
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseReadingFormFilter> outerInstance;
...
public:
  ...
  virtual void testKatakanaReadings() ;

  virtual void testKatakanaReadingsHalfWidth() ;
...
public:
  virtual void testRomajiReadings() ;

  virtual void testRomajiReadingsHalfWidth() ;
...
protected:
  std::shared_ptr<TestJapaneseReadingFormFilter> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseReadingFormFilter>(
