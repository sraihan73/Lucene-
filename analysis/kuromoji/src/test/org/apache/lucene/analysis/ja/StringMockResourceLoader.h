...
/** Fake resource loader for tests: works if you want to fake reading a single
 * file */
class StringMockResourceLoader
    : public std::enable_shared_from_this<StringMockResourceLoader>,
      public ResourceLoader
{
  GET_CLASS_NAME(StringMockResourceLoader)
public:
  std::wstring text;

  StringMockResourceLoader(const std::wstring &text);
