 ...
 */
class TestJapaneseReadingFormFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseReadingFormFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseReadingFormFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestJapaneseReadingFormFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseReadingFormFilterFactory>(
