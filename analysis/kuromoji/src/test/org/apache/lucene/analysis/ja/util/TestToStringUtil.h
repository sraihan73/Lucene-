...
private:
  ...
  private:
    std::shared_ptr<TestToStringUtil> outerInstance;

  public:
    HashMapAnonymousInnerClass(std::shared_ptr<TestToStringUtil> outerInstance);
...
protected:
  std::shared_ptr<TestToStringUtil> shared_from_this()
  {
    return std::static_pointer_cast<TestToStringUtil>(
