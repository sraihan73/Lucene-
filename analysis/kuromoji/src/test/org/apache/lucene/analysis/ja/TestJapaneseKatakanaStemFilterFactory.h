 ...
 */
class TestJapaneseKatakanaStemFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseKatakanaStemFilterFactory)
public:
  virtual void testKatakanaStemming() ;
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseKatakanaStemFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestJapaneseKatakanaStemFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseKatakanaStemFilterFactory>(
