 ...
 */
class TestJapaneseIterationMarkCharFilterFactory
    : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseIterationMarkCharFilterFactory)

public:
  virtual void testIterationMarksWithKeywordTokenizer() ;

  virtual void testIterationMarksWithJapaneseTokenizer() ;
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseIterationMarkCharFilterFactory> outerInstance;

  public:
    HashMapAnonymousInnerClass(
        std::shared_ptr<TestJapaneseIterationMarkCharFilterFactory>
            outerInstance);
...
protected:
  std::shared_ptr<TestJapaneseIterationMarkCharFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseIterationMarkCharFilterFactory>(
