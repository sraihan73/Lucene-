...
/**
 * Simple tests for {@link
 * org.apache.lucene.analysis.ja.JapaneseNumberFilterFactory}
 */
class TestJapaneseNumberFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseNumberFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseNumberFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestJapaneseNumberFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseNumberFilterFactory>(
