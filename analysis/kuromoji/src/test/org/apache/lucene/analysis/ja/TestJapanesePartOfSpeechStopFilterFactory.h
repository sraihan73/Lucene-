 ...
 */
class TestJapanesePartOfSpeechStopFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapanesePartOfSpeechStopFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestJapanesePartOfSpeechStopFilterFactory> outerInstance;

  public:
    HashMapAnonymousInnerClass(
        std::shared_ptr<TestJapanesePartOfSpeechStopFilterFactory>
            outerInstance);
...
protected:
  std::shared_ptr<TestJapanesePartOfSpeechStopFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapanesePartOfSpeechStopFilterFactory>(
