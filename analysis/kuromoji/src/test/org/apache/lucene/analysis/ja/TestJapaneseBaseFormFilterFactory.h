 ...
 */
class TestJapaneseBaseFormFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestJapaneseBaseFormFilterFactory)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestJapaneseBaseFormFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestJapaneseBaseFormFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestJapaneseBaseFormFilterFactory>(
