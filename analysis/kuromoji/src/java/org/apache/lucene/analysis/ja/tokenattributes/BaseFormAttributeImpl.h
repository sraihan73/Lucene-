 ...
 */
class BaseFormAttributeImpl : public AttributeImpl,
                              public BaseFormAttribute,
                              public Cloneable
{
  GET_CLASS_NAME(BaseFormAttributeImpl)
private:
  std::shared_ptr<Token> token;

public:
  std::wstring getBaseForm() override;
...
protected:
  std::shared_ptr<BaseFormAttributeImpl> shared_from_this()
  {
    return std::static_pointer_cast<BaseFormAttributeImpl>(
