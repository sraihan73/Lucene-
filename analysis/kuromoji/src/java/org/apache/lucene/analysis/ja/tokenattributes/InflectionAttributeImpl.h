 ...
 */
class InflectionAttributeImpl : public AttributeImpl,
                                public InflectionAttribute,
                                public Cloneable
{
  GET_CLASS_NAME(InflectionAttributeImpl)
private:
  std::shared_ptr<Token> token;

public:
  std::wstring getInflectionType() override;

  std::wstring getInflectionForm() override;
...
protected:
  std::shared_ptr<InflectionAttributeImpl> shared_from_this()
  {
    return std::static_pointer_cast<InflectionAttributeImpl>(
