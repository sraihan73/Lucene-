...
{
using Position = org::apache::lucene::analysis::ja::JapaneseTokenizer::Position;
...
void GraphvizFormatter::onBacktrace(shared_ptr<JapaneseTokenizer> tok,
...
wstring
GraphvizFormatter::formatNodes(shared_ptr<JapaneseTokenizer> tok,
                               shared_ptr<WrappedPositionArray> positions,
