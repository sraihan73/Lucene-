 ...
 */
class ReadingAttributeImpl : public AttributeImpl,
                             public ReadingAttribute,
                             public Cloneable
{
  GET_CLASS_NAME(ReadingAttributeImpl)
private:
...
public:
  ...
  std::wstring getPronunciation() override;
...
protected:
  std::shared_ptr<ReadingAttributeImpl> shared_from_this()
  {
    return std::static_pointer_cast<ReadingAttributeImpl>(
