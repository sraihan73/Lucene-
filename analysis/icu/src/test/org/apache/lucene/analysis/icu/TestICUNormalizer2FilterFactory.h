...
class TestICUNormalizer2FilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestICUNormalizer2FilterFactory)
...
private:
  ...
  private:
    std::shared_ptr<TestICUNormalizer2FilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestICUNormalizer2FilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestICUNormalizer2FilterFactory>(
