...
class TestICUNormalizer2CharFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestICUNormalizer2CharFilterFactory)
...
private:
  ...
  private:
    std::shared_ptr<TestICUNormalizer2CharFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestICUNormalizer2CharFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestICUNormalizer2CharFilterFactory>(
