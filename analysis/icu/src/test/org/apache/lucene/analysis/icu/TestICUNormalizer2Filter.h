 ...
 */
class TestICUNormalizer2Filter : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestICUNormalizer2Filter)
public:
...
private:
  ...
  private:
    std::shared_ptr<TestICUNormalizer2Filter> outerInstance;
...
protected:
  std::shared_ptr<TestICUNormalizer2Filter> shared_from_this()
  {
    return std::static_pointer_cast<TestICUNormalizer2Filter>(
