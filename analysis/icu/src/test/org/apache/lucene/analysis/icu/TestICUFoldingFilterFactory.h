...
class TestICUFoldingFilterFactory : public BaseTokenStreamTestCase
{
  GET_CLASS_NAME(TestICUFoldingFilterFactory)
...
private:
  ...
  private:
    std::shared_ptr<TestICUFoldingFilterFactory> outerInstance;
...
protected:
  std::shared_ptr<TestICUFoldingFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<TestICUFoldingFilterFactory>(
