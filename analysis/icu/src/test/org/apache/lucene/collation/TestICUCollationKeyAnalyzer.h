...
class TestICUCollationKeyAnalyzer : public CollationTestBase
{
  GET_CLASS_NAME(TestICUCollationKeyAnalyzer)

private:
  std::shared_ptr<Collator> collator =
      Collator::getInstance(std::make_shared<Locale>(L"fa"));
...
protected:
  std::shared_ptr<TestICUCollationKeyAnalyzer> shared_from_this()
  {
    return std::static_pointer_cast<TestICUCollationKeyAnalyzer>(
