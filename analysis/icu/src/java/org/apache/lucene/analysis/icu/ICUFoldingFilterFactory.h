 ...
 * &lt;fieldType name="text_folded" class="solr.TextField"
 * positionIncrementGap="100"&gt; &lt;analyzer&gt; &lt;tokenizer
 * class="solr.WhitespaceTokenizerFactory"/&gt; &lt;filter
 * class="solr.ICUFoldingFilterFactory"/&gt; &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * @since 3.1.0
 */
class ICUFoldingFilterFactory : public TokenFilterFactory,
                                public MultiTermAwareComponent
{
  GET_CLASS_NAME(ICUFoldingFilterFactory)
private:
  const std::shared_ptr<Normalizer2> normalizer;

  /** Creates a new ICUFoldingFilterFactory */
public:
  ICUFoldingFilterFactory(std::unordered_map<std::wstring, std::wstring> &args);
...
protected:
  std::shared_ptr<ICUFoldingFilterFactory> shared_from_this()
  {
    return std::static_pointer_cast<ICUFoldingFilterFactory>(
